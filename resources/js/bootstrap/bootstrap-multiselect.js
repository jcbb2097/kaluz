!function($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            nonSelectedText: 'Ningún registro',
            nSelectedText: 'selected'
        },

        // Templates.
        templates: {
            button: '<button id="siu" type="button"  class="multiselect dropdown-toggle ojo" data-toggle="dropdown"></button>',
        ...
        createOptionValue: function(element) {
            ...
            $('label', $li).append('<div class="'+c+'"><p>'+label+"</p></div>");
        ...
        updateButtonText: function() {
            ...
            $('button', this.$container).html("<p id='textop'>"+this.options.buttonText(options, this.$select)+"</p>");
