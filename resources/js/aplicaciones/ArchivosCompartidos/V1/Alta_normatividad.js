    ...
    $(form).bootstrapValidator({
        ...
        fields: {
            ...
            cate: {
                ...
                validators: {
                    notEmpty: {
                        message: 'Por favor, Seleccione el área del archivo'
                    }
                }
            },
            categoria: {
                        ...
                        $.confirm({
                            ...
                            buttons:{
                                aceptar:{
                                    ...
                                    action: function () {
                                        //$("#formEjes")[0].reset();
                                        window.location.href = "lista_normatividad.php?nombreUsuario=" + $("#usuario").val()+"&idUsuario="+ $("#idUsuario").val()+"&tipoPerfil=1";
                                    }
                                }
                            }
                        });
