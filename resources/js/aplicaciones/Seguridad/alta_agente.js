...
$(document).ready(function(){
    ...
    var form = "#formAgentes";
    var controller = "../../../WEB-INF/Controllers/Seguridad/Controler_agentes.php";
        ...
        fields: {
           nombre: {
            ...
            tf: {
                validators: {
                    notEmpty: {
                        message: 'Por favor, Ingrese un tipo de fuego'
                    }
                }
            }
        }
    ...
    $.confirm({
        ...
        buttons: 
        {
            aceptar: 
            {
                ...
                action: function()
                {
                    $.post('../../../WEB-INF/Controllers/Seguridad/Controler_agentes.php',{id:Id, accion:"eliminar"}, function(data)
                    {
                        if (data.toString().indexOf("Error:") === -1) {
                            //$.dialog(data);
                                $.confirm({
