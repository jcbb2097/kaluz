...
$(document).ready(function(){
    ...
    var form = "#formEstatusE";
    var controller = "../../../WEB-INF/Controllers/Seguridad/Controler_estatuse.php";
                        ...
                        buttons: 
                        {
                            aceptar: 
                            {
                                ...
                                {   
                                    ...
                                    window.location.href="seguridad.php?nombreUsuario="+$("#usuario").val()+"&menu_seguridad=catalogos&id_t=lista_extintor"; 
                                }
                            }
                        }
                    });  
    ...
    $.confirm({
        ...
        buttons: 
        {
            aceptar: 
            {
                ...
                action: function()
                {
                    $.post('../../../WEB-INF/Controllers/Seguridad/Controler_estatuse.php',{id:Id, accion:"eliminar"}, function(data)
                    {
                        if (data.toString().indexOf("Error:") === -1) {
                            //$.dialog(data);
                                $.confirm({
