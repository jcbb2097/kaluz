...
$(document).ready(function(){
	...
	var form = "#formDefinirColaboradores";
	var controller = "../../../WEB-INF/Controllers/Publicaciones/Controller_definirColaboradores.php";
	
	$('#indicadorColaboradores').DataTable(
        {
          "language": {
  ...
  /* $(form).bootstrapValidator({
        ...
        fields: {
           rutaEntregable: {
                validators: {
                    notEmpty: {
                        message: 'Por favor, Ingrese un entregable'
                    }
                }
            }
		}
						...
						buttons:
						{
							aceptar:
							{
								...
								action: function()
								{
									...
									//cambiarContenido('#ContenidosMenuPar','alta_definirColaboradores.php?aDC=1');
									if($("#accion").val() == 'editar'){
										cambiarContenido('#ContenidosMenuPar','alta_definirColaboradores.php?accion=editar&aDC=1&IdLibro='+$("#id").val());
									}
									if($("#accion").val() == 'guardar'){
										cambiarContenido('#ContenidosMenuPar','alta_definirColaboradores.php?accion=editar&aDC=1');
									}
								}
							}
						}
...
{
	//console.log("entra");
	window.location.href="alta_definirColaboradores.php?accion=editar&id="+Id+"&usuario="+user;
}
