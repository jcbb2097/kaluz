...
$(document).ready(function(){
	...
	var form = "#formCarpetaPresentacion";
	var controller = "../../../WEB-INF/Controllers/Publicaciones/Controller_carpetaPresentacion.php";
	
	$('#indicadorCarpetaPresentación').DataTable(
        {
          "language": {
						...
						buttons:
						{
							aceptar:
							{
								...
								action: function()
								{
									...
									//cambiarContenido('#ContenidosMenuPar','alta_elaborarCarpetaPresentacion.php?aDC=1');
									if($("#accion").val() == 'editar'){
										cambiarContenido('#ContenidosMenuPar','alta_elaborarCarpetaPresentacion.php?accion=editar&aDC=1&IdLibro='+$("#id").val());
									}
									if($("#accion").val() == 'guardar'){
										cambiarContenido('#ContenidosMenuPar','alta_elaborarCarpetaPresentacion.php?accion=editar&aDC=1');
									}
								}
							}
						}
...
{
	//console.log("entra");
	window.location.href="alta_elaborarCarpetaPresentacion.php?accion=editar&id="+Id+"&usuario="+user;
}
