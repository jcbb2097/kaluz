...
$(document).ready(function(){
	...
	var form = "#formRutacritica";
	var controller = "../../../WEB-INF/Controllers/Publicaciones/Controller_elaborarRutaCritica.php";
	
	$('#indicadorRutaCritica').DataTable(
        {
          "language": {
						...
						buttons:
						{
							aceptar:
							{
								...
								action: function()
								{
									...
									//cambiarContenido('#ContenidosMenuPar','alta_elaborarRutaCritica.php?aDC=1');
									if($("#accion").val() == 'editar'){
										cambiarContenido('#ContenidosMenuPar','alta_elaborarRutaCritica.php?accion=editar&aDC=1&IdLibro='+$("#id").val());
									}
									if($("#accion").val() == 'guardar'){
										cambiarContenido('#ContenidosMenuPar','alta_elaborarRutaCritica.php?accion=editar&aDC=1');
									}
								}
							}
						}
