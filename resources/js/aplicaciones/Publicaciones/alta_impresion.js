...
$(document).ready(function(){
	...
	var form = "#formImpresion";
	var controller = "../../../WEB-INF/Controllers/Publicaciones/Controller_impresionPublicacion.php";
						...
						buttons:
						{
							aceptar:
							{
								...
								action: function()
								{
									...
									cambiarContenido('#ContenidosMenuGeneral','alta_impresion.php?aDF=1&IdLibro='+$("#id").val());
								}
							}
						}
					});
