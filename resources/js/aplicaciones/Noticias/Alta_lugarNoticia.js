$(document).ready(function(){
    ...
    var form = "#formLugarNoticia";
    var controller = "../../../WEB-INF/Controllers/Noticias/Controler_lugarNoticia.php";

    $('#tLugarNoticias').DataTable(
    {
        "language": 
        {
                    ...
                    if (data.toString().indexOf("Error:") === -1) {
                        ...
                        buttons: 
                        {
                            aceptar: 
                            {
                                ...
                                {   
                                    //$("#formEjes")[0].reset();
                                    cambiarContenido('#contenido','Lista_lugarNoticia.php?nombreUsuario='+$("#usuario").val());
