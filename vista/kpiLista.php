<?php
	include_once __DIR__."/../source/controller/KpiController.php";
	...
	foreach($kpis as $kpi){
		...
		if($kpi->getId() == 73 || $kpi->getId() == 48 || $kpi->getId() == 78 )
		{
			$blank = " target='_blank' ";
		}else{
			$blank = "";
		}
		$cadena .= "<a style='    color: black; text-decoration: none;' ".$blank." href='".$kpi->getLiga()."'>".$i.". ".$kpi->getDescripcion()." ".$valorPercent." </a>";
		$i++;
	}
