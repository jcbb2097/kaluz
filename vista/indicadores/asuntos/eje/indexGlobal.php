<?php
	...
	$asuntos = $act -> mostrarTotalAsuntosGlobalesRecibidosEje($idEje);
	$total = $asuntos -> getTotal();
	
	$asuntosPro = $act -> mostrarTotalAsuntosProGlobalesRecibidosEje($idEje);
	$totalPro = $asuntosPro -> getTotal();
	
	$asuntosSol = $act -> mostrarTotalAsuntosSolGlobalesRecibidosEje($idEje);
	$totalSol = $asuntosSol -> getTotal();
	
	$asuntosCon = $act -> mostrarTotalAsuntosConGlobalesRecibidosEje($idEje);
	$totalCon = $asuntosCon -> getTotal();
	
	$asuntosSug = $act -> mostrarTotalAsuntosSugGlobalesRecibidosEje($idEje);
	...
	$subArea = $actSub -> mostrarTotalAsuntosSubAreaGlobalesRecibidosEje($idEje);
	...
	{		
		...
		if($asuntosArea->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraArea(".$area->getIdArea().",1,0,".$idUsuario.",".$idAreaUsuario.",\"".$area->getNombre()."\",\"".$nombreEje."\")' "; $style="style='background-color: #0093a3;color: white;'"; $seleccion .="$('#ae1".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje1').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje1').css('background-color','#4d4d57'); } );"; }
		...
		if($asuntosArea2->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraArea(".$area->getIdArea().",2,0,".$idUsuario.",".$idAreaUsuario.",\"".$area->getNombre()."\",\"".$nombreEje."\")' "; $style="style='background-color: #0093a3;color: white;'"; $seleccion .="$('#ae2".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje2').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje2').css('background-color','#4d4d57'); } );"; }
		...
		if($asuntosArea3->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraArea(".$area->getIdArea().",3,0,".$idUsuario.",".$idAreaUsuario.",\"".$area->getNombre()."\",\"".$nombreEje."\")' "; $style="style='background-color: #0093a3;color: white;'"; $seleccion .="$('#ae3".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje3').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje3').css('background-color','#4d4d57'); } );"; }
		...
		if($asuntosArea4->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraArea(".$area->getIdArea().",4,0,".$idUsuario.",".$idAreaUsuario.",\"".$area->getNombre()."\",\"".$nombreEje."\")' "; $style="style='background-color: #0093a3;color: white;'"; $seleccion .="$('#ae4".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje4').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje4').css('background-color','#4d4d57'); } );"; }
		...
		if($asuntosArea5->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraArea(".$area->getIdArea().",5,0,".$idUsuario.",".$idAreaUsuario.",\"".$area->getNombre()."\",\"".$nombreEje."\")' "; $style="style='background-color: #0093a3;color: white;'"; $seleccion .="$('#ae5".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje5').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje5').css('background-color','#4d4d57'); } );"; }
		...
		if($asuntosArea6->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraArea(".$area->getIdArea().",6,0,".$idUsuario.",".$idAreaUsuario.",\"".$area->getNombre()."\",\"".$nombreEje."\")' "; $style="style='background-color: #0093a3;color: white;'"; $seleccion .="$('#ae6".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje6').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje6').css('background-color','#4d4d57'); } );"; }
		...
		if($asuntosArea7->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraArea(".$area->getIdArea().",7,0,".$idUsuario.",".$idAreaUsuario.",\"".$area->getNombre()."\",\"".$nombreEje."\")' "; $style="style='background-color: #0093a3;color: white;'"; $seleccion .="$('#ae7".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje7').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje7').css('background-color','#4d4d57'); } );"; }
		...
		if($asuntosArea8->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraArea(".$area->getIdArea().",8,0,".$idUsuario.",".$idAreaUsuario.",\"".$area->getNombre()."\",\"".$nombreEje."\")' "; $style="style='background-color: #0093a3;color: white;'"; $seleccion .="$('#ae8".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje8').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje8').css('background-color','#4d4d57'); } );"; }
		...
		if($asuntosArea9->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraArea(".$area->getIdArea().",9,0,".$idUsuario.",".$idAreaUsuario.",\"".$area->getNombre()."\",\"".$nombreEje."\")' "; $style="style='background-color: #0093a3;color: white;'"; $seleccion .="$('#ae9".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje9').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje9').css('background-color','#4d4d57'); } );"; }
		...
		if($asuntosArea10->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraArea(".$area->getIdArea().",10,0,".$idUsuario.",".$idAreaUsuario.",\"".$area->getNombre()."\",\"".$nombreEje."\")' "; $style="style='background-color: #0093a3;color: white;'"; $seleccion .="$('#ae10".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje10').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje10').css('background-color','#4d4d57'); } );"; }
		...
		if($asuntosArea11->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraArea(".$area->getIdArea().",11,0,".$idUsuario.",".$idAreaUsuario.",\"".$area->getNombre()."\",\"".$nombreEje."\")' "; $style="style='background-color: #0093a3;color: white;'"; $seleccion .="$('#aeje11".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje11').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje11').css('background-color','#4d4d57'); } );"; }
	...
	$totalDR = $actT -> mostrarTotalAsuntosResueltosGlobalesRecibidosEje($idEje);
	...
	{ 
		$totalSubAreaDiv = $actTotSub -> mostrarTotalAsuntosGlobalesRecibidosSubAreaDivEje($subA->getIdArea(),$idEje);
	...
	$estPro = $actEst -> mostrarTotalEstatusAsuntosProGlobalesRecibidosEje($idEje);
	...
	$estSol = $actEst -> mostrarTotalEstatusAsuntosSolGlobalesRecibidosEje($idEje);
	...
	$estCon = $actEst -> mostrarTotalEstatusAsuntosConGlobalesRecibidosEje($idEje);
	...
	$estSug = $actEst -> mostrarTotalEstatusAsuntosSugGlobalesRecibidosEje($idEje);
	...
	$estTodo = $actEst -> mostrarTotalEstatusAsuntosTodoGlobalesRecibidosEje($idEje);
...
<body>
<div class="well2 ">
	Indicador global de asuntos recibidos al eje de <?php echo $nombreEje; ?>
...
<div class="well2 wr">
	...
	<div  class="clasifTodo">
		<p onclick="tipoEstatus(5,1,<?php echo $estTodoR; ?>);" style="cursor:pointer;background-color: #5cb85c;z-index:10;" class="b pclasifTodo"><?php echo $estTodoR; ?></p>
		<p onclick="tipoEstatus(5,2,<?php echo $estTodoEC; ?>);" style="cursor:pointer;background-color: #efd707;z-index:10;" class="b pclasifTodo"><?php echo $estTodoEC; ?></p>
		<p onclick="tipoEstatus(5,3,<?php echo $estTodoNL; ?>);" style="cursor:pointer;background-color: #d9534f;z-index:10;" class="b pclasifTodo"><?php echo $estTodoNL; ?></p>
	</div>
	...
	<div  class="clasifPro">
		<p onclick="tipoEstatus(4,1,<?php echo $estProR; ?>);" style="cursor:pointer;background-color: #5cb85c;z-index:10;" class="b pclasifPro"><?php echo $estProR; ?></p>
		<p onclick="tipoEstatus(4,2,<?php echo $estProEC; ?>);" style="cursor:pointer;background-color: #efd707;z-index:10;" class="b pclasifPro"><?php echo $estProEC; ?></p>
		<p onclick="tipoEstatus(4,3,<?php echo $estProNL; ?>);" style="cursor:pointer;background-color: #d9534f;z-index:10;" class="b pclasifPro"><?php echo $estProNL; ?></p>
	</div>
	<div  class="clasifSol">
		<p onclick="tipoEstatus(1,1,<?php echo $estSolR; ?>);" style="cursor:pointer;background-color: #5cb85c;z-index:10;" class="b pclasifSol "><?php echo $estSolR; ?></p>
		<p onclick="tipoEstatus(1,2,<?php echo $estSolEC; ?>);" style="cursor:pointer;background-color: #efd707;z-index:10;" class="b pclasifSol"><?php echo $estSolEC; ?></p>
		<p onclick="tipoEstatus(1,3,<?php echo $estSolNL; ?>);" style="cursor:pointer;background-color: #d9534f;z-index:10;" class="b pclasifSol"><?php echo $estSolNL; ?></p>
	</div>
	<div  class="clasifCon">
		<p onclick="tipoEstatus(2,1,<?php echo $estConR; ?>);" style="cursor:pointer;background-color: #5cb85c;z-index:10;" class="b pclasifCon"><?php echo $estConR; ?></p>
		<p onclick="tipoEstatus(2,2,<?php echo $estConEC; ?>);" style="cursor:pointer;background-color: #efd707;z-index:10;" class="b pclasifCon"><?php echo $estConEC; ?></p>
		<p onclick="tipoEstatus(2,3,<?php echo $estConNL; ?>);" style="cursor:pointer;background-color: #d9534f;z-index:10;" class="b pclasifCon"><?php echo $estConNL; ?></p>
	</div>
	<div  class="clasifSug">
		<p onclick="tipoEstatus(3,1,<?php echo $estSugR; ?>);" style="cursor:pointer;background-color: #5cb85c;z-index:10;" class="b pclasifSug"><?php echo $estSugR; ?></p>
		<p onclick="tipoEstatus(3,2,<?php echo $estSugEC; ?>);" style="cursor:pointer;background-color: #efd707;z-index:10;" class="b pclasifSug"><?php echo $estSugEC; ?></p>
		<p onclick="tipoEstatus(3,3,<?php echo $estSugNL; ?>);" style="cursor:pointer;background-color: #d9534f;z-index:10;" class="b pclasifSug"><?php echo $estSugNL; ?></p>
	</div>
...
<div class="global">
	<div style="top: 54px;" class="flotante">
		...
		<div class="totEj" >
			<p class="totEjeFin"></p>
			<p  class="totEjeFinPercent"></p>
			<p class="totEjeFinPercent2"></p>
		</div>
		<?php	
			}
		?>
...
function tipoEstatus(tipo,estatus,total)
{
	...
	var idUsuario = <?php echo $idUsuario;?>;
	var idAreaUsuario = <?php echo $idAreaUsuario;?>;
	var idEje = <?php echo $idEje;?>;
	
	$.post("asuntosTipoEstatusGlobal.php",{idEje:idEje,idArea:idArea,tipo:tipo,total:total,idUsuario:idUsuario,idAreaUsuario:idAreaUsuario,estatus:estatus}, function(data) {
		$(".global").html('');
		$(".global").html(data);
	});
}
