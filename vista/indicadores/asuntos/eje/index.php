...
<div class="well2 wr">
	<b style="    position: absolute;left: 7px;"><?php echo $totalAmbos; ?></b>
...
<div class="global">
	<div style="top: 54px;" class="flotante">
		...
		<div class="totEj" >
			...
			<p <?php if($percent1Eje == 100){ echo "style='font-weight: bold;font-size: 11px;' "; } ?> class="totEjeFinPercent"><?php echo number_format($percent1Eje, 1, '.', '');?>% atendido</p>
	...
	<div class="flotante" style="top: 52px;">
		...
		<div class="totEj" >
			...
			<p <?php if($percent2Eje == 100){ echo "style='font-weight: bold;font-size: 11px;' "; } ?>  class="totEjeFinPercent"><?php echo number_format($percent2Eje, 1, '.', '');?>% atendido</p>
	...
	<div class="flotante" style="top: 51px;">
		...
		<div class="totEj" >
			...
			<p <?php if($percent3Eje == 100){ echo "style='font-weight: bold;font-size: 11px;' "; } ?>  class="totEjeFinPercent"><?php echo number_format($percent3Eje, 1, '.', '');?>% atendido</p>
	...
	<div class="flotante" style="top: 50px;">
		...
		<div class="totEj" >
			...
			<p <?php if($percent4Eje == 100){ echo "style='font-weight: bold;font-size: 11px;' "; } ?>  class="totEjeFinPercent"><?php echo number_format($percent4Eje, 1, '.', '');?>% atendido</p>
	...
	<div class="flotante" style="top: 49px;">
		...
		<div class="totEj" >
			...
			<p <?php if($percent5Eje == 100){ echo "style='font-weight: bold;font-size: 11px;' "; } ?>  class="totEjeFinPercent"><?php echo number_format($percent5Eje, 1, '.', '');?>% atendido</p>
	...
	<div class="flotante" style="top: 48px;">
		...
		<div class="totEj" >
			...
			<p <?php if($percent6Eje == 100){ echo "style='font-weight: bold;font-size: 11px;' "; } ?>  class="totEjeFinPercent"><?php echo number_format($percent6Eje, 1, '.', '');?>% atendido</p>
	...
	<div class="flotante" style="top: 47px;">
		...
		<div class="totEj" >
			...
			<p <?php if($percent7Eje == 100){ echo "style='font-weight: bold;font-size: 11px;' "; } ?>  class="totEjeFinPercent"><?php echo number_format($percent7Eje, 1, '.', '');?>% atendido</p>
	...
	<div class="flotante" style="top: 46px;">
		...
		<div class="totEj" >
			...
			<p <?php if($percent8Eje == 100){ echo "style='font-weight: bold;font-size: 11px;' "; } ?>  class="totEjeFinPercent"><?php echo number_format($percent8Eje, 1, '.', '');?>% atendido</p>
	...
	<div class="flotante" style="top: 45px;">
		...
		<div class="totEj" >
			...
			<p <?php if($percent9Eje == 100){ echo "style='font-weight: bold;font-size: 11px;' "; } ?>  class="totEjeFinPercent"><?php echo number_format($percent9Eje, 1, '.', '');?>% atendido</p>
	...
	<div class="flotante" style="top: 44px;">
		...
		<div class="totEj" >
			...
			<p <?php if($percent10Eje == 100){ echo "style='font-weight: bold;font-size: 11px;' "; } ?>  class="totEjeFinPercent"><?php echo number_format($percent10Eje, 1, '.', '');?>% atendido</p>
	...
	<div class="flotante" style="top: 43px;">
		...
		<div class="totEj" >
			...
			<p <?php if($percent11Eje == 100){ echo "style='font-weight: bold;font-size: 11px;' "; } ?>  class="totEjeFinPercent"><?php echo number_format($percent11Eje, 1, '.', '');?>% atendido</p>
...
function tipoEstatus(tipo,estatus,total)
{
	...
	$.post("asuntosTipoEstatusParticular.php",{idArea:idArea,tipo:tipo,total:total,idUsuario:idUsuario,idAreaUsuario:idAreaUsuario,estatus:estatus}, function(data) {
		$(".global").html('');
		$(".global").html(data);
	});
}
