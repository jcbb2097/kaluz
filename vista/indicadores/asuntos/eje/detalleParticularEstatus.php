...
function responder(idConversacion) 
{
	...
	location.replace("/sie/vista/apps/Asuntos/index.php?ac=1&idUsuario="+idUsuario+"&idArea="+idArea+"&anio="+anio+"&tipo=0&opcion=recibido&idEje=0&idAreaU="+idAreaUsuario+"&idConversacion="+idConversacion); 
}
