...
<div class="well2 ">
	...
	<i onclick="javascript:location.href='indexEnviados.php?idArea=<?php echo $idArea; ?>&nombreArea=<?php echo $nombreArea; ?>&idUsuario=<?php echo $idUsuario; ?>&idAreaUsuario=<?php echo $idAreaUsuario; ?>'" data-toggle="tooltip" data-placement="bottom" title="Enviados área" style=";position: absolute;left: 369px;cursor:pointer;" class="fa fa-paper-plane" aria-hidden="true"></i> 
	
	<i onclick="javascript:location.href='indexGlobalEnviados.php?idArea=<?php echo $idArea; ?>&nombreArea=<?php echo $nombreArea; ?>&idUsuario=<?php echo $idUsuario; ?>&idAreaUsuario=<?php echo $idAreaUsuario; ?>'" data-toggle="tooltip" data-placement="bottom" title="Enviados Global" style="position: absolute;right: 495px;cursor:pointer;" class="fa fa-globe" aria-hidden="true"></i>
...
<div class="well2 wr">
	...
	<div  class="clasifTodo">
		<p onclick="tipoEstatus(5,1,<?php echo $estTodoR; ?>,91);" style="cursor:pointer;background-color: #5cb85c;" class="b pclasifTodo todo1"><?php echo $estTodoR; ?></p>
		<p onclick="tipoEstatus(5,2,<?php echo $estTodoEC; ?>,92);" style="cursor:pointer;background-color: #efd707;" class="b pclasifTodo todo2"><?php echo $estTodoEC; ?></p>
		<p onclick="tipoEstatus(5,3,<?php echo $estTodoNL; ?>,93);" style="cursor:pointer;background-color: #d9534f;" class="b pclasifTodo todo3"><?php echo $estTodoNL; ?></p>
	</div>
...
function tipoEstatus(tipo,estatus,total,estatusRegreso)
{
	...
	$.post("asuntosTipoEstatusGlobal.php",{idArea:idArea,tipo:tipo,total:total,idUsuario:idUsuario,idAreaUsuario:idAreaUsuario,estatus:estatus,estatusRegreso:estatusRegreso}, function(data) {
		$(".global").html('');
		$(".global").html(data);
	});
}
...
function muestraDetalleEstatus(idDestino,idEje,tipo,idUsuario,idAreaUsuario,estatus,estatusRegreso)
{
	...
	$.post("detalleGlobalEstatus.php",{idDestino:idDestino,idEje:idEje,tipo:tipo,idUsuario:idUsuario,idAreaUsuario:idAreaUsuario,estatus:estatus,estatusRegreso:estatusRegreso}, function(data) {
		$(".detalle").html('');
		$(".detalle").html(data);
	});
