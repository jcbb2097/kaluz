<?php
	...
	{		
		$asuntosArea = $act -> mostrarTotalAsuntosRecibidosAreaTipoInvitado($idArea,$area->getIdArea(),1,$tipo);
		if($asuntosArea->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",1,".$tipo.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae1".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje1').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje1').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea2 = $act -> mostrarTotalAsuntosRecibidosAreaTipoInvitado($idArea,$area->getIdArea(),2,$tipo);
		if($asuntosArea2->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",2,".$tipo.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae2".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje2').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje2').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea3 = $act -> mostrarTotalAsuntosRecibidosAreaTipoInvitado($idArea,$area->getIdArea(),3,$tipo);
		if($asuntosArea3->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",3,".$tipo.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae3".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje3').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje3').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea4 = $act -> mostrarTotalAsuntosRecibidosAreaTipoInvitado($idArea,$area->getIdArea(),4,$tipo);
		if($asuntosArea4->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",4,".$tipo.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae4".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje4').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje4').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea5 = $act -> mostrarTotalAsuntosRecibidosAreaTipoInvitado($idArea,$area->getIdArea(),5,$tipo);
		if($asuntosArea5->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",5,".$tipo.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae5".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje5').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje5').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea6 = $act -> mostrarTotalAsuntosRecibidosAreaTipoInvitado($idArea,$area->getIdArea(),6,$tipo);
		if($asuntosArea6->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",6,".$tipo.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae6".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje6').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje6').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea7 = $act -> mostrarTotalAsuntosRecibidosAreaTipoInvitado($idArea,$area->getIdArea(),7,$tipo);
		if($asuntosArea7->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",7,".$tipo.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae7".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje7').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje7').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea8 = $act -> mostrarTotalAsuntosRecibidosAreaTipoInvitado($idArea,$area->getIdArea(),8,$tipo);
		if($asuntosArea8->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",8,".$tipo.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae8".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje8').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje8').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea9 = $act -> mostrarTotalAsuntosRecibidosAreaTipoInvitado($idArea,$area->getIdArea(),9,$tipo);
		if($asuntosArea9->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",9,".$tipo.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae9".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje9').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje9').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea10 = $act -> mostrarTotalAsuntosRecibidosAreaTipoInvitado($idArea,$area->getIdArea(),10,$tipo);
		if($asuntosArea10->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",10,".$tipo.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae10".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje10').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje10').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea11 = $act -> mostrarTotalAsuntosRecibidosAreaTipoInvitado($idArea,$area->getIdArea(),11,$tipo);
		if($asuntosArea11->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",11,".$tipo.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#aeje11".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje11').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje11').css('background-color','#4d4d57'); } );"; }
		...
		$atendidos = $act -> mostrarTotalAsuntosAtendidosRecibidosInvitadoArea($idArea,$area->getIdArea(),$tipo);
		if($totalesArea > 0)
		{
	...
	$totAtenEje1 = $actAten->mostrarTotalAsuntosAtendidosRecibidosInvitadoEje(1,$idArea,$tipo);
	$percent1Eje = 0.0;
	if($totEje1 > 0){ $percent1Eje = ($totAtenEje1->getTotal() / $totEje1)*100; }
	
	$totAtenEje2 = $actAten->mostrarTotalAsuntosAtendidosRecibidosInvitadoEje(2,$idArea,$tipo);
	$percent2Eje = 0.0;
	if($totEje2 > 0){ $percent2Eje = ($totAtenEje2->getTotal() / $totEje2)*100; }
	
	$totAtenEje3 = $actAten->mostrarTotalAsuntosAtendidosRecibidosInvitadoEje(3,$idArea,$tipo);
	$percent3Eje = 0.0;
	if($totEje3 > 0){ $percent3Eje = ($totAtenEje3->getTotal() / $totEje3)*100; }
	
	$totAtenEje4 = $actAten->mostrarTotalAsuntosAtendidosRecibidosInvitadoEje(4,$idArea,$tipo);
	$percent4Eje = 0.0;
	if($totEje4 > 0){ $percent4Eje = ($totAtenEje4->getTotal() / $totEje4)*100; }
	
	$totAtenEje5 = $actAten->mostrarTotalAsuntosAtendidosRecibidosInvitadoEje(5,$idArea,$tipo);
	$percent5Eje = 0.0;
	if($totEje5 > 0){ $percent5Eje = ($totAtenEje5->getTotal() / $totEje5)*100; }
	
	$totAtenEje6 = $actAten->mostrarTotalAsuntosAtendidosRecibidosInvitadoEje(6,$idArea,$tipo);
	$percent6Eje = 0.0;
	if($totEje6 > 0){ $percent6Eje = ($totAtenEje6->getTotal() / $totEje6)*100; }
	
	$totAtenEje7 = $actAten->mostrarTotalAsuntosAtendidosRecibidosInvitadoEje(7,$idArea,$tipo);
	$percent7Eje = 0.0;
	if($totEje7 > 0){ $percent7Eje = ($totAtenEje7->getTotal() / $totEje7)*100; }
	
	$totAtenEje8 = $actAten->mostrarTotalAsuntosAtendidosRecibidosInvitadoEje(8,$idArea,$tipo);
	$percent8Eje = 0.0;
	if($totEje8 > 0){ $percent8Eje = ($totAtenEje8->getTotal() / $totEje8)*100; }
	
	$totAtenEje9 = $actAten->mostrarTotalAsuntosAtendidosRecibidosInvitadoEje(9,$idArea,$tipo);
	$percent9Eje = 0.0;
	if($totEje9 > 0){ $percent9Eje = ($totAtenEje9->getTotal() / $totEje9)*100; }
	
	$totAtenEje10 = $actAten->mostrarTotalAsuntosAtendidosRecibidosInvitadoEje(10,$idArea,$tipo);
	$percent10Eje = 0.0;
	if($totEje10 > 0){ $percent10Eje = ($totAtenEje10->getTotal() / $totEje10)*100; }
	
	$totAtenEje11 = $actAten->mostrarTotalAsuntosAtendidosRecibidosInvitadoEje(11,$idArea,$tipo);
	$percent11Eje = 0.0;
