<?php
	...
	{		
		$asuntosArea = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusParticulares($area->getIdArea(),$idArea,1,$tipo,$estatus);
		if($asuntosArea->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalleEstatus(".$idArea.",".$area->getIdArea().",1,".$tipo.",".$idUsuario.",".$idAreaUsuario.",".$estatus.",".$estatusRegreso.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae1".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje1').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje1').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea2 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusParticulares($area->getIdArea(),$idArea,2,$tipo,$estatus);
		if($asuntosArea2->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalleEstatus(".$idArea.",".$area->getIdArea().",2,".$tipo.",".$idUsuario.",".$idAreaUsuario.",".$estatus.",".$estatusRegreso.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae2".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje2').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje2').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea3 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusParticulares($area->getIdArea(),$idArea,3,$tipo,$estatus);
		if($asuntosArea3->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalleEstatus(".$idArea.",".$area->getIdArea().",3,".$tipo.",".$idUsuario.",".$idAreaUsuario.",".$estatus.",".$estatusRegreso.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae3".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje3').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje3').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea4 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusParticulares($area->getIdArea(),$idArea,4,$tipo,$estatus);
		if($asuntosArea4->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalleEstatus(".$idArea.",".$area->getIdArea().",4,".$tipo.",".$idUsuario.",".$idAreaUsuario.",".$estatus.",".$estatusRegreso.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae4".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje4').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje4').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea5 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusParticulares($area->getIdArea(),$idArea,5,$tipo,$estatus);
		if($asuntosArea5->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalleEstatus(".$idArea.",".$area->getIdArea().",5,".$tipo.",".$idUsuario.",".$idAreaUsuario.",".$estatus.",".$estatusRegreso.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae5".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje5').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje5').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea6 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusParticulares($area->getIdArea(),$idArea,6,$tipo,$estatus);
		if($asuntosArea6->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalleEstatus(".$idArea.",".$area->getIdArea().",6,".$tipo.",".$idUsuario.",".$idAreaUsuario.",".$estatus.",".$estatusRegreso.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae6".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje6').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje6').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea8 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusParticulares($area->getIdArea(),$idArea,8,$tipo,$estatus);
		if($asuntosArea8->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalleEstatus(".$idArea.",".$area->getIdArea().",8,".$tipo.",".$idUsuario.",".$idAreaUsuario.",".$estatus.",".$estatusRegreso.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae8".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje8').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje8').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea9 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusParticulares($area->getIdArea(),$idArea,9,$tipo,$estatus);
		if($asuntosArea9->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalleEstatus(".$idArea.",".$area->getIdArea().",9,".$tipo.",".$idUsuario.",".$idAreaUsuario.",".$estatus.",".$estatusRegreso.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae9".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje9').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje9').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea10 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusParticulares($area->getIdArea(),$idArea,10,$tipo,$estatus);
		if($asuntosArea10->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalleEstatus(".$idArea.",".$area->getIdArea().",10,".$tipo.",".$idUsuario.",".$idAreaUsuario.",".$estatus.",".$estatusRegreso.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#ae10".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje10').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje10').css('background-color','#4d4d57'); } );"; }
		...
		$asuntosArea11 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusParticulares($area->getIdArea(),$idArea,11,$tipo,$estatus);
		if($asuntosArea11->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalleEstatus(".$idArea.",".$area->getIdArea().",11,".$tipo.",".$idUsuario.",".$idAreaUsuario.",".$estatus.",".$estatusRegreso.")' "; $style="style='background-color: ".$styleColor.";color:white;'"; $seleccion .="$('#aeje11".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje11').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje11').css('background-color','#4d4d57'); } );"; }
