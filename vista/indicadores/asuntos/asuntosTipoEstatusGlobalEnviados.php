<?php
	...
	{		
		$asuntosArea = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusGlobales($area->getIdArea(),1,$tipo,$estatus);
		...
		$asuntosArea2 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusGlobales($area->getIdArea(),2,$tipo,$estatus);
		...
		$asuntosArea3 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusGlobales($area->getIdArea(),3,$tipo,$estatus);
		...
		$asuntosArea4 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusGlobales($area->getIdArea(),4,$tipo,$estatus);
		...
		$asuntosArea5 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusGlobales($area->getIdArea(),5,$tipo,$estatus);
		...
		$asuntosArea6 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusGlobales($area->getIdArea(),6,$tipo,$estatus);
		...
		$asuntosArea7 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusGlobales($area->getIdArea(),7,$tipo,$estatus);
		...
		$asuntosArea8 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusGlobales($area->getIdArea(),8,$tipo,$estatus);
		...
		$asuntosArea9 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusGlobales($area->getIdArea(),9,$tipo,$estatus);
		...
		$asuntosArea10 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusGlobales($area->getIdArea(),10,$tipo,$estatus);
		...
		$asuntosArea11 = $act -> mostrarTotalAsuntosEnviadosAreaTipoEstatusGlobales($area->getIdArea(),11,$tipo,$estatus);
