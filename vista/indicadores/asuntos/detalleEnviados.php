...
function responder(idConversacion) 
{
	...
	location.replace("/sie/vista/apps/Asuntos/index.php?ind=11&estatusIndicador=0&ac=1&idUsuario="+idUsuario+"&idArea="+idArea+"&anio="+anio+"&tipo=0&opcion=enviado&idEje=0&idAreaU="+idAreaUsuario+"&idConversacion="+idConversacion); 
}
