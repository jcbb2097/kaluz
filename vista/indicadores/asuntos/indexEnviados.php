<?php
	...
	$asuntos = $act -> mostrarTotalAsuntosEnviados($idArea);
	...
	$subArea = $actSub -> mostrarTotalAsuntosEnviadosSubArea($idArea);
	$totalEnviadosSubArea = $subArea -> getTotal();
	/**********/
	...
	$totalDR = $actT -> mostrarTotalAsuntosEnviadosResueltos($idArea);
	...
	{
		$totalSubAreaDiv = $actTotSub -> mostrarTotalAsuntosEnviadosSubAreaDiv($idArea,$subA->getIdArea());
	...
	$estPro = $actEst -> mostrarTotalEstatusAsuntosEnviadosPro($idArea);
	...
	$estSol = $actEst -> mostrarTotalEstatusAsuntosEnviadosSol($idArea);
	...
	$estCon = $actEst -> mostrarTotalEstatusAsuntosEnviadosCon($idArea);
	...
	$estSug = $actEst -> mostrarTotalEstatusAsuntosEnviadosSug($idArea);
	...
	$estTodo = $actEst -> mostrarTotalEstatusAsuntosEnviadosTodo($idArea);
...
<div class="well2 ">
	...
	<div onclick="muestraResueltos(<?php echo $idArea; ?>,<?php echo $idUsuario; ?>,<?php echo $idAreaUsuario; ?>,0)" style="cursor:pointer;" data-toggle="tooltip" data-placement="bottom" title="Enviados  <?php echo number_format($percentResul, 1, '.', '');?>% de avance resueltos" class="progress clsPro">
...
<!--
	...
	-->
	<i onclick="javascript:location.href='indexEnviados.php?idArea=<?php echo $idArea; ?>&nombreArea=<?php echo $nombreArea; ?>&idUsuario=<?php echo $idUsuario; ?>&idAreaUsuario=<?php echo $idAreaUsuario; ?>'" data-toggle="tooltip" data-placement="bottom" title="Enviados área" style="color: #00BCD4;position: absolute;left: 339px;cursor:pointer;" class="fa fa-paper-plane" aria-hidden="true"></i> 
	
	<i onclick="javascript:location.href='index.php?idArea=<?php echo $idArea; ?>&nombreArea=<?php echo $nombreArea; ?>&idUsuario=<?php echo $idUsuario; ?>&idAreaUsuario=<?php echo $idAreaUsuario; ?>'" data-toggle="tooltip" data-placement="bottom" title="ver recibidos" style="position: absolute;right: 41px;cursor:pointer;" class="fa fa-envelope-open" aria-hidden="true"></i> 
	
	<i onclick="javascript:location.href='indexGlobalEnviados.php?idArea=<?php echo $idArea; ?>&nombreArea=<?php echo $nombreArea; ?>&idUsuario=<?php echo $idUsuario; ?>&idAreaUsuario=<?php echo $idAreaUsuario; ?>'" data-toggle="tooltip" data-placement="bottom" title="Enviados Global" style="position: absolute;right: 9px;cursor:pointer;" class="fa fa-globe" aria-hidden="true"></i>
	
</div>
<div class="well2 wr">
	
	<p style="position: absolute;left: 29px;top: 33px;">Totales</p>
	<p data-toggle="tooltip" data-placement="bottom" title="Directos" style="cursor:pointer;border: 1px solid #fff;left:77px;color:white;top: 33px;" onclick="window.location.reload();" class="totales a "><?php echo $total; ?></p>
	...
	<div class="titleSub">Tot. sub-áreas&nbsp;&nbsp; <b><?php echo $totalEnviadosSubArea; ?></b></div>
		...
		<div class="modal-content" style="left: -6px;width: 624px;">
			<div class="modal-header h" style="padding: 7px 5px;">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				 Asuntos enviados por el área de <b><?php echo $nombreArea; ?></b> <a style="color:white;text-decoration:none;" class="resul"></a>
			</div>
...
function muestraDetalle(idOrigen,idDestino,idEje,tipo,idUsuario,idAreaUsuario)
{
	...
	$.post("detalleEnviados.php",{idDestino:idDestino,idOrigen:idOrigen,idEje:idEje,tipo:tipo,idUsuario:idUsuario,idAreaUsuario:idAreaUsuario}, function(data) {
		$(".detalle").html('');
		$(".detalle").html(data);
	});
...
$(document).ready(function(){
 ...
 $("#subArea").change(function() {
	...
	$.post("detalleEnviados.php",{idDestino:idSubArea,idOrigen:idDestino,idEje:idEje,tipo:tipo,idUsuario:idUsuario,idAreaUsuario:idAreaUsuario}, function(data) {
		$(".detalle").html('');
		$(".detalle").html(data);
	});
});
...
function tipoEstatus(tipo,estatus,total,estatusRegreso)
{
	...
	$.post("asuntosTipoEstatusParticularEnviados.php",{idArea:idArea,tipo:tipo,total:total,idUsuario:idUsuario,idAreaUsuario:idAreaUsuario,estatus:estatus,estatusRegreso:estatusRegreso}, function(data) {
		$(".global").html('');
		$(".global").html(data);
	});
}

function muestraDetalleEstatus(idOrigen,idDestino,idEje,tipo,idUsuario,idAreaUsuario,estatus,estatusRegreso)
{
	var idDestino = idDestino;
	var idOrigen = idOrigen;
	var idEje = idEje;
	...
	$.post("detalleParticularEstatusEnviado.php",{idDestino:idDestino,idOrigen:idOrigen,idEje:idEje,tipo:tipo,idUsuario:idUsuario,idAreaUsuario:idAreaUsuario,estatus:estatus,estatusRegreso:estatusRegreso}, function(data) {
		$(".detalle").html('');
		$(".detalle").html(data);
	});
