<?php
	...
	$asuntos = $act -> mostrarDetalleAsuntosRecibidosEstatusGlobales($idDestino,$idEje,$tipo,$estatus);
	$cadenaTabla = "";
	$i = 1;
	$color = "";
	$ultimaAct = "";
...
function responder(idConversacion) 
{
	...
	location.replace("/sie/vista/apps/Asuntos/index.php?ind=3&estatusIndicador="+estatusRegreso+"&ac=1&idUsuario="+idUsuario+"&idArea="+idArea+"&anio="+anio+"&tipo=0&opcion=recibido&idEje=0&idAreaU="+idAreaUsuario+"&idConversacion="+idConversacion); 
}
