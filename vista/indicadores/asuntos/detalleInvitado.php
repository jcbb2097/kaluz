<?php
	...
	$asuntos = $act -> mostrarDetalleAsuntosRecibidosInvitado($idDestino,$idOrigen,$idEje,$tipo);
	$cadenaTabla = "";
	$i = 1;
	$color = "";
	$ultimaAct = "";
...
function responder(idConversacion) 
{
	...
	location.replace("/sie/vista/apps/Asuntos/index.php?ac=1&idUsuario="+idUsuario+"&idArea="+idArea+"&anio="+anio+"&tipo=0&opcion=invitado&idEje=0&idAreaU="+idAreaUsuario+"&idConversacion="+idConversacion); 
}
