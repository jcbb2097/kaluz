<?php
	...
	$asuntos = $act -> mostrarDetalleAsuntosRecibidos($idDestino,$idOrigen,$idEje,$tipo);
	$cadenaTabla = "";
	$i = 1;
	$color = "";
	$ultimaAct = "";
...
function responder(idConversacion) 
{
	...
	location.replace("/sie/vista/apps/Asuntos/index.php?ind=2&estatusIndicador=0&ac=1&idUsuario="+idUsuario+"&idArea="+idArea+"&anio="+anio+"&tipo=0&opcion=recibido&idEje=0&idAreaU="+idAreaUsuario+"&idConversacion="+idConversacion); 
}
