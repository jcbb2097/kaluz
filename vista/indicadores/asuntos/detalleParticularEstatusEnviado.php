...
function responder(idConversacion) 
{
	...
	var idArea = <?php echo $idOrigen; ?>;
	var idUsuario = <?php echo $idUsuario; ?>;
	var idAreaUsuario = <?php echo $idAreaUsuario; ?>;
	var estatusRegreso = <?php echo $estatusRegreso; ?>;
	location.replace("/sie/vista/apps/Asuntos/index.php?ind=11&estatusIndicador="+estatusRegreso+"&ac=1&idUsuario="+idUsuario+"&idArea="+idArea+"&anio="+anio+"&tipo=0&opcion=enviado&idEje=0&idAreaU="+idAreaUsuario+"&idConversacion="+idConversacion); 
}
