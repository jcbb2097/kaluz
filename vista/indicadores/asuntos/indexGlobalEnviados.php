<?php
	...
	$subArea = $actSub -> mostrarTotalAsuntosSubAreaGlobalesEnviados();
	...
	{		
		...
		$asuntosArea = $act -> mostrarTotalAsuntosAreaGlobalesEnviados($area->getIdArea(),1);
		...
		$asuntosArea2 = $act -> mostrarTotalAsuntosAreaGlobalesEnviados($area->getIdArea(),2);
		...
		$asuntosArea3 = $act -> mostrarTotalAsuntosAreaGlobalesEnviados($area->getIdArea(),3);
		...
		$asuntosArea4 = $act -> mostrarTotalAsuntosAreaGlobalesEnviados($area->getIdArea(),4);
		...
		$asuntosArea5 = $act -> mostrarTotalAsuntosAreaGlobalesEnviados($area->getIdArea(),5);
		...
		$asuntosArea6 = $act -> mostrarTotalAsuntosAreaGlobalesEnviados($area->getIdArea(),6);
		...
		$asuntosArea7 = $act -> mostrarTotalAsuntosAreaGlobalesEnviados($area->getIdArea(),7);
		...
		$asuntosArea8 = $act -> mostrarTotalAsuntosAreaGlobalesEnviados($area->getIdArea(),8);
		...
		$asuntosArea9 = $act -> mostrarTotalAsuntosAreaGlobalesEnviados($area->getIdArea(),9);
		...
		$asuntosArea10 = $act -> mostrarTotalAsuntosAreaGlobalesEnviados($area->getIdArea(),10);
		...
		$asuntosArea11 = $act -> mostrarTotalAsuntosAreaGlobalesEnviados($area->getIdArea(),11);
	...
	{
		$totalSubAreaDiv = $actTotSub -> mostrarTotalAsuntosEnviadosSubAreaDivGlobales($subA->getIdArea());
...
<body>
<div class="well2 ">
	Indicador global de asuntos enviados 
	...
	<i onclick="javascript:location.href='indexEnviados.php?idArea=<?php echo $idArea; ?>&nombreArea=<?php echo $nombreArea; ?>&idUsuario=<?php echo $idUsuario; ?>&idAreaUsuario=<?php echo $idAreaUsuario; ?>'" data-toggle="tooltip" data-placement="bottom" title="Enviados área" style=";position: absolute;left: 339px;cursor:pointer;" class="fa fa-paper-plane" aria-hidden="true"></i> 
	<i onclick="javascript:location.href='index.php?idArea=<?php echo $idArea; ?>&nombreArea=<?php echo $nombreArea; ?>&idUsuario=<?php echo $idUsuario; ?>&idAreaUsuario=<?php echo $idAreaUsuario; ?>'" data-toggle="tooltip" data-placement="bottom" title="Recibidos área" style="position: absolute;left: 369px;cursor:pointer;" class="fa fa-envelope-open" aria-hidden="true"></i> 
	
	<i onclick="javascript:location.href='indexGlobal.php?idArea=<?php echo $idArea; ?>&nombreArea=<?php echo $nombreArea; ?>&idUsuario=<?php echo $idUsuario; ?>&idAreaUsuario=<?php echo $idAreaUsuario; ?>'" data-toggle="tooltip" data-placement="bottom" title="Recibidos Global" style="position: absolute;right: 495px;cursor:pointer;" class="fa fa-globe" aria-hidden="true"></i>
	
	
	<i onclick="javascript:location.href='indexGlobalEnviados.php?idArea=<?php echo $idArea; ?>&nombreArea=<?php echo $nombreArea; ?>&idUsuario=<?php echo $idUsuario; ?>&idAreaUsuario=<?php echo $idAreaUsuario; ?>'" data-toggle="tooltip" data-placement="bottom" title="Enviados Global" style="color: #00BCD4;position: absolute;right: 9px;cursor:pointer;" class="fa fa-globe" aria-hidden="true"></i>
...
<div class="well2 wr">
	...
	<!-- onclick="javascript:location.href='../focosAsuntos/focoProblematicaGlobal.php?idArea=< ?php echo $idArea; ?>&nombreArea=< ?php echo $nombreArea; ?>&idUsuario=< ?php echo $idUsuario; ?>&idAreaUsuario=< ?php echo $idAreaUsuario; ?>'" -->
	<div class="btn-group btn-group-justified groupMod">
		<a style="background-color: #4d4d57;border: 1px solid #a9a9ae;"  class="btn btn-primary btnMod">Problemática &nbsp;<b style="background-color: #0093a3;color:white;">&nbsp;<?php echo $totalPro; ?>&nbsp;</b></a>
	...
	<div  class="clasifPro">
		<p onclick="tipoEstatus(4,1,<?php echo $estProR; ?>,41);" style="cursor:pointer;background-color: #5cb85c;z-index: 10;" class="b pclasifPro pro1"><?php echo $estProR; ?></p>
		<p onclick="tipoEstatus(4,2,<?php echo $estProEC; ?>,42);" style="cursor:pointer;background-color: #efd707;z-index: 10;" class="b pclasifPro pro2"><?php echo $estProEC; ?></p>
		<p onclick="tipoEstatus(4,3,<?php echo $estProNL; ?>,43);" style="cursor:pointer;background-color: #d9534f;z-index: 10;" class="b pclasifPro pro3"><?php echo $estProNL; ?></p>
	</div>
	<div  class="clasifSol">
		<p onclick="tipoEstatus(1,1,<?php echo $estSolR; ?>,11);" style="cursor:pointer;background-color: #5cb85c;z-index: 10;" class="b pclasifSol sol1"><?php echo $estSolR; ?></p>
		<p onclick="tipoEstatus(1,2,<?php echo $estSolEC; ?>,12);" style="cursor:pointer;background-color: #efd707;z-index: 10;" class="b pclasifSol sol2"><?php echo $estSolEC; ?></p>
		<p onclick="tipoEstatus(1,3,<?php echo $estSolNL; ?>,13);" style="cursor:pointer;background-color: #d9534f;z-index: 10;" class="b pclasifSol sol3"><?php echo $estSolNL; ?></p>
	</div>
	<div  class="clasifCon">
		<p onclick="tipoEstatus(2,1,<?php echo $estConR; ?>,21);" style="cursor:pointer;background-color: #5cb85c;z-index: 10;" class="b pclasifCon con1"><?php echo $estConR; ?></p>
		<p onclick="tipoEstatus(2,2,<?php echo $estConEC; ?>,22);" style="cursor:pointer;background-color: #efd707;z-index: 10;" class="b pclasifCon con2"><?php echo $estConEC; ?></p>
		<p onclick="tipoEstatus(2,3,<?php echo $estConNL; ?>,23);" style="cursor:pointer;background-color: #d9534f;z-index: 10;" class="b pclasifCon con3"><?php echo $estConNL; ?></p>
	</div>
	<div  class="clasifSug">
		<p onclick="tipoEstatus(3,1,<?php echo $estSugR; ?>,31);" style="cursor:pointer;background-color: #5cb85c;z-index: 10;" class="b pclasifSug sug1"><?php echo $estSugR; ?></p>
		<p onclick="tipoEstatus(3,2,<?php echo $estSugEC; ?>,32);" style="cursor:pointer;background-color: #efd707;z-index: 10;" class="b pclasifSug sug2"><?php echo $estSugEC; ?></p>
		<p onclick="tipoEstatus(3,3,<?php echo $estSugNL; ?>,33);" style="cursor:pointer;background-color: #d9534f;z-index: 10;" class="b pclasifSug sug3"><?php echo $estSugNL; ?></p>
	</div>
		...
		<div class="modal-content" style="left: -6px;width: 624px;">
			<div class="modal-header h" style="padding: 7px 5px;">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				 Asuntos enviados   <a style="color:white;text-decoration:none;" class="resul"></a>
			</div>
...
function muestraDetalle(idDestino,idEje,tipo,idUsuario,idAreaUsuario)
{
	...
	$.post("detalleGlobalEnviados.php",{idDestino:idDestino,idEje:idEje,tipo:tipo,idUsuario:idUsuario,idAreaUsuario:idAreaUsuario}, function(data) {
		$(".detalle").html('');
		$(".detalle").html(data);
	});
...
$(document).ready(function(){
 ...
 $("#subArea").change(function() {
	...
	$.post("detalleGlobalEnviados.php",{idDestino:idSubArea,idOrigen:idDestino,idEje:idEje,tipo:tipo,idUsuario:idUsuario,idAreaUsuario:idAreaUsuario}, function(data) {
		$(".detalle").html('');
		$(".detalle").html(data);
	});
});
...
function tipoEstatus(tipo,estatus,total,estatusRegreso)
{
	...
	$.post("asuntosTipoEstatusGlobalEnviados.php",{idArea:idArea,tipo:tipo,total:total,idUsuario:idUsuario,idAreaUsuario:idAreaUsuario,estatus:estatus,estatusRegreso:estatusRegreso}, function(data) {
		$(".global").html('');
		$(".global").html(data);
	});
}

function muestraDetalleEstatus(idDestino,idEje,tipo,idUsuario,idAreaUsuario,estatus,estatusRegreso)
{
	var idDestino = idDestino;
	var idEje = idEje;
	var tipo = tipo;
	...
	$.post("detalleGlobalEstatusEnviados.php",{idDestino:idDestino,idEje:idEje,tipo:tipo,idUsuario:idUsuario,idAreaUsuario:idAreaUsuario,estatus:estatus,estatusRegreso:estatusRegreso}, function(data) {
		$(".detalle").html('');
		$(".detalle").html(data);
	});
