<?php
	...
	$asuntos = $act -> mostrarTotalAsuntosRecibidosEjeArea($idArea,$idEje);
	$total = $asuntos -> getTotal();
	
	$asuntosPro = $act -> mostrarTotalAsuntosProRecibidosEjeArea($idArea,$idEje);
	$totalPro = $asuntosPro -> getTotal();
	
	$asuntosSol = $act -> mostrarTotalAsuntosSolRecibidosEjeArea($idArea,$idEje);
	$totalSol = $asuntosSol -> getTotal();
	
	$asuntosCon = $act -> mostrarTotalAsuntosConRecibidosEjeArea($idArea,$idEje);
	$totalCon = $asuntosCon -> getTotal();
	
	$asuntosSug = $act -> mostrarTotalAsuntosSugRecibidosEjeArea($idArea,$idEje);
	...
	$totalDR = $actT -> mostrarTotalAsuntosRecibidosDirectosResueltosEjeArea($idArea,$idEje);
	...
	$estPro = $actEst -> mostrarTotalEstatusAsuntosProRecibidosEjeArea($idArea,$idEje);
	...
	$estSol = $actEst -> mostrarTotalEstatusAsuntosSolRecibidosEjeArea($idArea,$idEje);
	...
	$estCon = $actEst -> mostrarTotalEstatusAsuntosConRecibidosEjeArea($idArea,$idEje);
	...
	$estSug = $actEst -> mostrarTotalEstatusAsuntosSugRecibidosEjeArea($idArea,$idEje);
	...
	$estTodo = $actEst -> mostrarTotalEstatusAsuntosTodoRecibidosEjeArea($idArea,$idEje);
...
<body>
<div class="well2 ">
	Asuntos recibidos al área de <b><?php echo $nombreArea; ?> en el eje de <?php echo $nombreEje; ?></b> 
	<p class="titRes" style="left: 512px;">resueltos <b><?php echo $directosR; ?> / <?php echo $total; ?></b></p>
	<div onclick="muestraResueltos(<?php echo $idArea; ?>,<?php echo $idUsuario; ?>,<?php echo $idAreaUsuario; ?>,0)" style="cursor:pointer;left: 511px;" data-toggle="tooltip" data-placement="bottom" title="Recibidos  <?php echo number_format($percentResul, 1, '.', '');?>% de avance resueltos" class="progress clsPro">
...
<!--
	...
	-->
	<i onclick="javascript:location.href='../index.php?idArea=<?php echo $idArea; ?>&nombreArea=<?php echo $nombreArea; ?>&idUsuario=<?php echo $idUsuario; ?>&idAreaUsuario=<?php echo $idAreaUsuario; ?>'" data-toggle="tooltip" data-placement="bottom" title="Regresar" style="color: white;position: absolute;left: 853px;cursor:pointer;" class="fas fa-arrow-alt-circle-left"></i>
	
</div>
<div class="well2 wr">
	
	<p style="position: absolute;left: 37px;">Totales</p>
	<p data-toggle="tooltip" data-placement="bottom" title="Directos" style="cursor:pointer;background-color:#0093a3;border: 1px solid green;left:86px;color:white;" onclick="window.location.reload();" class="totales a resalta"><?php echo $total; ?></p>
...
function tipoEstatus(tipo,estatus,total)
{
	...
	$.post("asuntosTipoEstatusParticular.php",{idEje:idEje,idArea:idArea,tipo:tipo,total:total,idUsuario:idUsuario,idAreaUsuario:idAreaUsuario,estatus:estatus}, function(data) {
		$(".global").html('');
		$(".global").html(data);
	});
}

function muestraDetalleEstatus(idDestino,idOrigen,idEje,tipo,idUsuario,idAreaUsuario,estatus)
{
	var idDestino = idDestino;
	var idOrigen = idOrigen;
	var idEje = idEje;
	...
	$.post("detalleParticularEstatus.php",{idDestino:idDestino,idOrigen:idOrigen,idEje:idEje,tipo:tipo,idUsuario:idUsuario,idAreaUsuario:idAreaUsuario,estatus:estatus}, function(data) {
		$(".detalle").html('');
		$(".detalle").html(data);
	});
