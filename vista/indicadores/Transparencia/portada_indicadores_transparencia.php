...
<body>
<div class="well well-sm"><a style="color:#fefefe;" href="../../indicadores.php?tipoPerfil=1">Indicadores</a> / <a style="color:#fefefe;" href="javascript:window.location.reload(true)">Portada de transparencia</a></div>
    <div class="container">
        <div class="row">
  ...
  <div id="menu" style="margin-top:50px;">
      <div class="container-fluid" style="margin-bottom: 5%">
          <div class="row justify-content-center">
              <div class="col-sm-3 cajas" >
                <a href="../../apps/Transparencia/inicio.php">
                <i class="fas fa-tasks fa-10x"></i></a>
                    <p class="cantidades" >Total de peticiones<span id="total_peticiones" ></span></p>
                    <span id="peticiones_total" style=" font-size: .7rem"></span>
              </div>
              <div class="col-sm-3 cajas" >
                <a href="../../apps/Transparencia/inicio.php">
                <i class="fas fa-bars fa-10x"></i></a>
                    <p class="cantidades" >Peticiones por eje  <span id="eje_peticiones" ></span> </p>
                    <span id="peticiones_eje" style=" font-size: .7rem"></span>
              </div>
                  <div class="col-sm-3 cajas" >
                    <a href="../../apps/Transparencia/inicio.php">
                    <i class="far fa-calendar-alt fa-10x"></i></a>
                    <p class="cantidades" >Peticiones por año <span id="anio_peticiones" ></span></p>
                    <span id="peticiones_anio" style=" font-size: .7rem"></span>
          ...
          <div class="row justify-content-center">
              <div class="col-sm-3 cajas">
                ...
                <p class="cantidades" >Peticiones por exposición <span id="expo_peticiones" ></span></p>
                <span id="peticiones_expo" style=" font-size: .7rem"></span>

              </div>
              <div class="col-sm-3 cajas" >
                <a href="../../apps/Transparencia/inicio.php">
                <i class="fas fa-layer-group fa-10x"></i></a>
                <p class="cantidades" >Peticiones por área <span id="origen_peticiones" ></span></p>
                <span id="peticiones_origen" style=" font-size: .7rem"></span>
              </div>
              <div class="col-sm-3 cajas" >
    ...
    <script src="./portada_transparencia.js"></script>
