<?php
	...
	$logrosArea = $actLogro -> mostrarDetallePorAreaProcesoExposicion($idEje,$tipo,$idExposicion);
	
	$cadenaArea ="";
	foreach($logrosArea as $logroArea)
	{
		$cadenaArea .="<span style='background-color: #ffb900 !important;' class='label label-warning'>".$logroArea->getNombreArea()." - ".$logroArea->getTotal()."</span> ";
	}
	
	
	$logros = $actLogro -> mostrarDetalleProcesoExposicion($idEje,$tipo,$idExposicion);
	$cadena ="";
