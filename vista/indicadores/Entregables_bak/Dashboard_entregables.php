...
<body>
    ...
    <div class="well2 wr">
        ...
        <p id="pa" data-toggle="tooltip" data-placement="bottom" title="Preliminar" style="top: 46px;cursor:pointer;background-color:#dfa739;border: 1px solid white;left:32px;color:white; <?php echo $stylo_2; ?>" onclick="tipo(9);" class="totales a  <?php echo $resalta_3; ?>"><?php echo $totales[2]; ?></p>
...
<script>
    ...
    function tipo(estatus) {
        ...
        var anio = $('#anio').val();
        var cate = $('#cate').val();
        url = "Dashboard_entregables.php?estatus=" + estatus + "&eje=" + eje + "&anio=" + anio + "&cate=" + cate;
    ...
    function filtros() {
        ...
        var cate = $('#cate').val();
        var tipo = $('#opcion').val();
        url = "Dashboard_entregables.php?estatus=" + tipo + "&eje=" + eje + "&anio=" + anio + "&cate=" + cate;
        $(location).attr('href', url);
