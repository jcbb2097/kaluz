...
if (isset($_POST['cate']) && $_POST['cate'] != "") {
    ...
    if ($categoria != '0') {
        $where_categoria = " AND ce.idCategoria=" . $categoria;
    }
}
$estatus = "";
                    ...
                    <table id="tabla_principal" class="table table-principal">
                        <thead class="table-header">
                            <tr>
                                ...
                                <th>Preliminar (<?php echo $totales[2]; ?>)</th>
	                    ...
	                    $where_ano2 $where_eje $where_categoria
                        ORDER BY e.orden,ce.orden";
                        ...
                        <tfoot class="table-header">
                            ...
                            <th>Preliminar (<?php echo $total_epr; ?>)</th>
