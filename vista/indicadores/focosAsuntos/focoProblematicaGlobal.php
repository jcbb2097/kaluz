<?php
	...
	$focos = $act -> mostrarTotalfocosGlobal();
	...
	{		
		$focosArea = $act -> mostrarTotalfocosGlobalArea($area->getIdArea(),1);
		...
		$focosArea2 = $act -> mostrarTotalfocosGlobalArea($area->getIdArea(),2);
		...
		$focosArea3 = $act -> mostrarTotalfocosGlobalArea($area->getIdArea(),3);
		...
		$focosArea4 = $act -> mostrarTotalfocosGlobalArea($area->getIdArea(),4);
		...
		$focosArea5 = $act -> mostrarTotalfocosGlobalArea($area->getIdArea(),5);
		...
		$focosArea6 = $act -> mostrarTotalfocosGlobalArea($area->getIdArea(),6);
		...
		$focosArea7 = $act -> mostrarTotalfocosGlobalArea($area->getIdArea(),7);
		...
		$focosArea8 = $act -> mostrarTotalfocosGlobalArea($area->getIdArea(),8);
		...
		$focosArea9 = $act -> mostrarTotalfocosGlobalArea($area->getIdArea(),9);
		...
		$focosArea10 = $act -> mostrarTotalfocosGlobalArea($area->getIdArea(),10);
		...
		$focosArea11 = $act -> mostrarTotalfocosGlobalArea($area->getIdArea(),11);
		...
		$cadenaTotalesArea .= "<div onclick='regresaArea(".$area->getIdArea().",\"".$area->getNombre()."\")'  id='totalArea".$area->getIdArea()."' style='cursor:pointer;'  class=' j2 horizontal'><p class='rotarT'>".$totalesArea."</p></div>";
	...
	$resueltos = $actC -> mostrarTotalfocosGlobalResueltos();
	$totalResueltos = $resueltos -> getTotal();
	
	$enSeguimiento = $actC -> mostrarTotalfocosGlobalEnSeguimiento();
	$totalEnSeguimiento = $enSeguimiento -> getTotal();
	
	$sinAtender = $actC -> mostrarTotalfocosGlobalSinAtender();
...
<body>
<div class="well2 ">Indicador global de focos de problemáticas 
<i onclick="javascript:location.href='focoProblematica.php?idArea=<?php echo $idArea; ?>&nombreArea=<?php echo $nombreArea; ?>&idUsuario=<?php echo $idUsuario; ?>&idAreaUsuario=<?php echo $idAreaUsuario; ?>'" data-toggle="tooltip" data-placement="bottom" title="Recibidos" style="position: absolute;right: 102px;cursor:pointer;" class="fa fa-envelope-open" aria-hidden="true"></i> 
<i onclick="javascript:location.href='focoProblematicaEnviados.php?idArea=<?php echo $idArea; ?>&nombreArea=<?php echo $nombreArea; ?>&idUsuario=<?php echo $idUsuario; ?>&idAreaUsuario=<?php echo $idAreaUsuario; ?>'" data-toggle="tooltip" data-placement="bottom" title="Enviados" style="position: absolute;right: 72px;cursor:pointer;" class="fa fa-paper-plane" aria-hidden="true"></i> 
<i onclick="javascript:location.href='focoProblematicaGraficas.php?idArea=<?php echo $idArea; ?>&nombreArea=<?php echo $nombreArea; ?>&idUsuario=<?php echo $idUsuario; ?>&idAreaUsuario=<?php echo $idAreaUsuario; ?>'" data-toggle="tooltip" data-placement="bottom" title="Gráficas" style="position: absolute;right: 39px;cursor:pointer; font-size: 13px;" class="far fa-chart-bar"></i> 
<i onclick="javascript:location.href='focoProblematicaGlobal.php?idArea=<?php echo $idArea; ?>&nombreArea=<?php echo $nombreArea; ?>&idUsuario=<?php echo $idUsuario; ?>&idAreaUsuario=<?php echo $idAreaUsuario; ?>'" data-toggle="tooltip" data-placement="bottom" title="Global" style="color: #00BCD4;position: absolute;right: 9px;cursor:pointer;" class="fa fa-globe" aria-hidden="true"></i>
</div>
<div class="well2 wr">
	...
	<div class="modal-dialog">
		...
		<div class="modal-content" style="left: -6px;width: 624px;">
			<div class="modal-header h" style="padding: 7px 5px;">
				...
				Indicador global de problemáticas recibidas al área de <b></b>
			</div>
...
function focosResueltos(tipo,total)
{
	...
	$.post("focoProblematicaGlobalEstatus.php",{idArea:idArea,tipo:tipo,total:total,idUsuario:idUsuario,idAreaUsuario:idAreaUsuario}, function(data) {
		$(".global").html('');
		$(".global").html(data);
	});
}
...
function muestraDetalle(idDestino,idOrigen,idEje,tipo)
{
	...
	$.post("detalleGlobal.php",{idDestino:idDestino,idOrigen:idOrigen,idEje:idEje,tipo:tipo,idUsuario:idUsuario,idAreaUsuario:idAreaUsuario}, function(data) {
		$(".detalle").html('');
		$(".detalle").html(data);
	});
...
function regresaArea(idArea,nombreArea)
{
	...
	location.href ='focoProblematica.php?idArea='+idArea+'&nombreArea='+nombreArea+'&idUsuario=<?php echo $idUsuario; ?>&idAreaUsuario=<?php echo $idAreaUsuario; ?>';
}
</script>
</html>
