<?php
	...
	$focos = $act -> mostrarTotalfocosEnviados($idArea);
	$total = $focos -> getTotal();
	
	/*total recibidos*/
	$focosR = $act -> mostrarTotalfocosRecibidos($idArea);
	$totalR = $focosR -> getTotal();
	/**/
	...
	{		
		$focosArea = $act -> mostrarTotalfocosEnviadosArea($area->getIdArea(),$idArea,1);
		if($focosArea->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$area->getIdArea().",".$idArea.",1,4)' "; $style="style='background-color: #aeb599;'"; $seleccion .="$('#ae1".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje1').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje1').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea2 = $act -> mostrarTotalfocosEnviadosArea($area->getIdArea(),$idArea,2);
		if($focosArea2->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$area->getIdArea().",".$idArea.",2,4)' "; $style="style='background-color: #aeb599;'"; $seleccion .="$('#ae2".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje2').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje2').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea3 = $act -> mostrarTotalfocosEnviadosArea($area->getIdArea(),$idArea,3);
		if($focosArea3->getTotal() == 0){$onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$area->getIdArea().",".$idArea.",3,4)' "; $style="style='background-color: #aeb599;'"; $seleccion .="$('#ae3".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje3').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje3').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea4 = $act -> mostrarTotalfocosEnviadosArea($area->getIdArea(),$idArea,4);
		if($focosArea4->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$area->getIdArea().",".$idArea.",4,4)' "; $style="style='background-color: #aeb599;'"; $seleccion .="$('#ae4".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje4').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje4').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea5 = $act -> mostrarTotalfocosEnviadosArea($area->getIdArea(),$idArea,5);
		if($focosArea5->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$area->getIdArea().",".$idArea.",5,4)' "; $style="style='background-color: #aeb599;'"; $seleccion .="$('#ae5".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje5').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje5').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea6 = $act -> mostrarTotalfocosEnviadosArea($area->getIdArea(),$idArea,6);
		if($focosArea6->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$area->getIdArea().",".$idArea.",6,4)' "; $style="style='background-color: #aeb599;'"; $seleccion .="$('#ae6".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje6').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje6').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea7 = $act -> mostrarTotalfocosEnviadosArea($area->getIdArea(),$idArea,7);
		if($focosArea7->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$area->getIdArea().",".$idArea.",7,4)' "; $style="style='background-color: #aeb599;'"; $seleccion .="$('#ae7".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje7').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje7').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea8 = $act -> mostrarTotalfocosEnviadosArea($area->getIdArea(),$idArea,8);
		if($focosArea8->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$area->getIdArea().",".$idArea.",8,4)' "; $style="style='background-color: #aeb599;'"; $seleccion .="$('#ae8".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje8').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje8').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea9 = $act -> mostrarTotalfocosEnviadosArea($area->getIdArea(),$idArea,9);
		if($focosArea9->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$area->getIdArea().",".$idArea.",9,4)' "; $style="style='background-color: #aeb599;'"; $seleccion .="$('#ae9".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje9').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje9').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea10 = $act -> mostrarTotalfocosEnviadosArea($area->getIdArea(),$idArea,10);
		if($focosArea10->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$area->getIdArea().",".$idArea.",10,4)' "; $style="style='background-color: #aeb599;'"; $seleccion .="$('#ae10".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje10').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje10').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea11 = $act -> mostrarTotalfocosEnviadosArea($area->getIdArea(),$idArea,11);
		if($focosArea11->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$area->getIdArea().",".$idArea.",11,4)' "; $style="style='background-color: #aeb599;'"; $seleccion .="$('#aeje11".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje11').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje11').css('background-color','#4d4d57'); } );"; }
	...
	$resueltos = $actC -> mostrarTotalfocosEnviadosResueltos($idArea);
	$totalResueltos = $resueltos -> getTotal();
	
	$enSeguimiento = $actC -> mostrarTotalfocosEnviadosEnSeguimiento($idArea);
	$totalEnSeguimiento = $enSeguimiento -> getTotal();
	
	$sinAtender = $actC -> mostrarTotalfocosEnviadosSinAtender($idArea);
	...
	/*porcentaje recibidos*/
	
	$actC = new IndicadorController();
	$resueltosR = $actC -> mostrarTotalfocosRecibidosResueltos($idArea);
	$totalResueltosR = $resueltosR -> getTotal();
	...
	if($totalR > 0)
	{
		$percent1R = ($totalResueltosR * 100)/ $totalR;
	}
	
	if($total > 0)
	{
		$percentE = ($totalResueltos * 100)/ $total;
	}
	/********************/
...
<body>
<div class="well2 ">Focos de problemáticas enviadas por <b><?php echo $nombreArea; ?></b>
	<div data-toggle="tooltip" data-placement="bottom" title="Recibidos <?php echo number_format($percent1R, 1, '.', '');?>% de avance resueltos" class="progress clsPro">
		<div class="clsProSub progress-bar progress-bar-success" role="progressbar"  style="width:<?php echo $percent1R;?>%">
		<?php echo number_format($percent1R, 1, '.', '');?>%
		</div>
	</div>
	<div data-toggle="tooltip" data-placement="bottom" title="Enviados <?php echo number_format($percentE, 1, '.', '');?>% de avance resueltos" class="progress clsProEnv">
		<div class="clsProSub progress-bar progress-bar-success" role="progressbar"  style="width:<?php echo $percentE;?>%">
		<?php echo number_format($percentE, 1, '.', '');?>%
		</div>
	</div>
	<i onclick="javascript:location.href='focoProblematica.php?idArea=<?php echo $idArea; ?>&nombreArea=<?php echo $nombreArea; ?>'" data-toggle="tooltip" data-placement="bottom" title="Recibidos" style="position: absolute;right: 342px;cursor:pointer;" class="fa fa-envelope-open" aria-hidden="true"></i> 
	<i onclick="javascript:location.href='focoProblematicaEnviados.php?idArea=<?php echo $idArea; ?>&nombreArea=<?php echo $nombreArea; ?>'"  data-toggle="tooltip" data-placement="bottom" title="Enviados" style="color: #00BCD4;position: absolute;right: 222px;cursor:pointer;" class="fa fa-paper-plane" aria-hidden="true"></i> 
...
<div class="well2 wr">
	Totales <p style="cursor:pointer" onclick="window.location.reload();" class="totales a "><?php echo $total; ?></p>
...
<div style="top: 33px;" class="modal fade" id="myModal" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content" style="left: -6px;width: 624px;">
			<div class="modal-header h" style="padding: 7px 5px;color:white;text-align:center;">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				Problemáticas enviadas por el área de <b><?php echo $nombreArea; ?></b>
			</div>
...
function focosResueltos(tipo,total)
{
	...
	var total = total;
	$.post("focoProblematicaEnviadosEstatus.php",{idArea:idArea,tipo:tipo,total:total}, function(data) {
		$(".global").html('');
		$(".global").html(data);
	});
}
