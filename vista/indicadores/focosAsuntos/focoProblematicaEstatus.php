<?php
	...
	{		
		$focosArea = $act -> mostrarTotalfocosRecibidosAreaEstatus($idArea,$area->getIdArea(),1,$tipo);
		if($focosArea->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",1,".$tipo.")' "; $style="style='background-color: ".$styleColor.";'"; $seleccion .="$('#ae1".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje1').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje1').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea2 = $act -> mostrarTotalfocosRecibidosAreaEstatus($idArea,$area->getIdArea(),2,$tipo);
		if($focosArea2->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",2,".$tipo.")' "; $style="style='background-color: ".$styleColor.";'"; $seleccion .="$('#ae2".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje2').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje2').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea3 = $act -> mostrarTotalfocosRecibidosAreaEstatus($idArea,$area->getIdArea(),3,$tipo);
		if($focosArea3->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",3,".$tipo.")' "; $style="style='background-color: ".$styleColor.";'"; $seleccion .="$('#ae3".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje3').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje3').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea4 = $act -> mostrarTotalfocosRecibidosAreaEstatus($idArea,$area->getIdArea(),4,$tipo);
		if($focosArea4->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",4,".$tipo.")' "; $style="style='background-color: ".$styleColor.";'"; $seleccion .="$('#ae4".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje4').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje4').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea5 = $act -> mostrarTotalfocosRecibidosAreaEstatus($idArea,$area->getIdArea(),5,$tipo);
		if($focosArea5->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",5,".$tipo.")' "; $style="style='background-color: ".$styleColor.";'"; $seleccion .="$('#ae5".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje5').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje5').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea6 = $act -> mostrarTotalfocosRecibidosAreaEstatus($idArea,$area->getIdArea(),6,$tipo);
		if($focosArea6->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",6,".$tipo.")' "; $style="style='background-color: ".$styleColor.";'"; $seleccion .="$('#ae6".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje6').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje6').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea7 = $act -> mostrarTotalfocosRecibidosAreaEstatus($idArea,$area->getIdArea(),7,$tipo);
		if($focosArea7->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",7,".$tipo.")' "; $style="style='background-color: ".$styleColor.";'"; $seleccion .="$('#ae7".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje7').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje7').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea8 = $act -> mostrarTotalfocosRecibidosAreaEstatus($idArea,$area->getIdArea(),8,$tipo);
		if($focosArea8->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",8,".$tipo.")' "; $style="style='background-color: ".$styleColor.";'"; $seleccion .="$('#ae8".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje8').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje8').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea9 = $act -> mostrarTotalfocosRecibidosAreaEstatus($idArea,$area->getIdArea(),9,$tipo);
		if($focosArea9->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",9,".$tipo.")' "; $style="style='background-color: ".$styleColor.";'"; $seleccion .="$('#ae9".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje9').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje9').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea10 = $act -> mostrarTotalfocosRecibidosAreaEstatus($idArea,$area->getIdArea(),10,$tipo);
		if($focosArea10->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",10,".$tipo.")' "; $style="style='background-color: ".$styleColor.";'"; $seleccion .="$('#ae10".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje10').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje10').css('background-color','#4d4d57'); } );"; }
		...
		$focosArea11 = $act -> mostrarTotalfocosRecibidosAreaEstatus($idArea,$area->getIdArea(),11,$tipo);
		if($focosArea11->getTotal() == 0){ $onclick = ""; $style = "style='opacity:.4;'";}else{ $onclick = "onclick='muestraDetalle(".$idArea.",".$area->getIdArea().",11,".$tipo.")' "; $style="style='background-color: ".$styleColor.";'"; $seleccion .="$('#aeje11".$area->getIdArea()."').hover(function(){ $(padre).find('div#a".$area->getIdArea()."').css('background-color','#0093a3'); $(padre).find('p.nEje11').css('background-color','#5d2852'); }, function() { $(padre).find('div#a".$area->getIdArea()."').css('background-color','#4d4d57'); $(padre).find('p.nEje11').css('background-color','#4d4d57'); } );"; }
