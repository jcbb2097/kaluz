<?php
	...
	{		
		$focosArea = $act -> mostrarTotalfocosGlobalAreaEstatus($area->getIdArea(),1,$tipo);
		...
		$focosArea2 = $act -> mostrarTotalfocosGlobalAreaEstatus($area->getIdArea(),2,$tipo);
		...
		$focosArea3 = $act -> mostrarTotalfocosGlobalAreaEstatus($area->getIdArea(),3,$tipo);
		...
		$focosArea4 = $act -> mostrarTotalfocosGlobalAreaEstatus($area->getIdArea(),4,$tipo);
		...
		$focosArea5 = $act -> mostrarTotalfocosGlobalAreaEstatus($area->getIdArea(),5,$tipo);
		...
		$focosArea6 = $act -> mostrarTotalfocosGlobalAreaEstatus($area->getIdArea(),6,$tipo);
		...
		$focosArea7 = $act -> mostrarTotalfocosGlobalAreaEstatus($area->getIdArea(),7,$tipo);
		...
		$focosArea8 = $act -> mostrarTotalfocosGlobalAreaEstatus($area->getIdArea(),8,$tipo);
		...
		$focosArea9 = $act -> mostrarTotalfocosGlobalAreaEstatus($area->getIdArea(),9,$tipo);
		...
		$focosArea10 = $act -> mostrarTotalfocosGlobalAreaEstatus($area->getIdArea(),10,$tipo);
		...
		$focosArea11 = $act -> mostrarTotalfocosGlobalAreaEstatus($area->getIdArea(),11,$tipo);
