...
<body>
<div class="well well-sm"><a style="color:#fefefe;" href="../../indicadores.php?tipoPerfil=1">Indicadores</a> / <a style="color:#fefefe;" href="javascript:window.location.reload(true)">Portada de instrumentos juridicos</a></div>
    <div class="container">
        <div class="row">
  ...
  <div id="menu" style="margin-top:50px;">
      <div class="container-fluid" style="margin-bottom: 5%">
          <div class="row justify-content-center">
              <div class="col-sm-3 cajas" >
                <a href="../../apps/Juridico/index.php">
                <i class="fas fa-tasks fa-10x"></i></a>
                    <p class="cantidades" >Total de instrumentos<span id="total_instrumentos" ></span></p>
                    <span id="instrumentos_total" style=" font-size: .7rem"></span>
              </div>
              <div class="col-sm-3 cajas" >
                <a href="../../apps/Juridico/index.php">
                <i class="fas fa-bars fa-10x"></i></a>
                    <p class="cantidades" >Instrumentos por eje  <span id="eje_instrumentos" ></span> </p>
                    <span id="instrumentos_eje" style=" font-size: .7rem"></span>
              </div>
                  <div class="col-sm-3 cajas" >
                    <a href="../../apps/Juridico/index.php">
                    <i class="far fa-calendar-alt fa-10x"></i></a>
                    <p class="cantidades" >Instrumentos por año <span id="anio_instrumentos" ></span></p>
                    <span id="instrumentos_anio" style=" font-size: .7rem"></span>
              </div>
          </div>
        </br>
          <div class="row justify-content-center">
              <div class="col-sm-3 cajas">
                ...
                <p class="cantidades" >Instrumentos por exposición <span id="expo_instrumentos" ></span></p>
                <span id="instrumentos_expo" style=" font-size: .7rem"></span>

              </div>
              <div class="col-sm-3 cajas" >
                <a href="../../apps/Juridico/index.php">
                <i class="fas fa-layer-group fa-10x"></i></a>
                <p class="cantidades" >Instrumentos por área <span id="origen_instrumentos" ></span></p>
                <span id="instrumentos_origen" style=" font-size: .7rem"></span>
              </div>
              <div class="col-sm-3 cajas" >
    ...
    <script src="./portada_juridico.js"></script>
