...
$consulta = mysqli_query($con, "SELECT (SELECT COUNT( id_acuerdo_escrito ) FROM c_acuerdospdf c_ac $joineje where estatus > -1 $where_fecha $where_eje $where_area $where_expo) AS total,
(SELECT COUNT( id_acuerdo_escrito ) FROM c_acuerdospdf c_ac $joineje where estatus = 1 $where_fecha $where_eje $where_area $where_expo) AS revisados,
(SELECT COUNT( id_acuerdo_escrito ) FROM c_acuerdospdf c_ac $joineje where estatus = 0 $where_fecha $where_eje $where_area $where_expo) AS norevisados");
