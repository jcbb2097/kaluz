...
<body>
<div class="well well-sm"><a style="color:#fefefe;" href="../../indicadores.php?tipoPerfil=1">Indicadores</a> / <a style="color:#fefefe;" href="javascript:window.location.reload(true)">Portada archivos compartidos</a></div>
    <div class="container">
        <div class="row">
  ...
  <div id="menu" style="margin-top:50px;">
      <div class="container-fluid" style="margin-bottom: 5%">
          <div class="row justify-content-center">
              <div class="col-sm-3 cajas" >
                <a href="../../apps/ArchivosCompartidos/Vista2.php">
                <i class="fas fa-tasks fa-10x"></i></a>
                    <p class="cantidades" >Total de archivos<span id="total_arch_compa" ></span></p>
                    <span id="arch_compa_total" style=" font-size: .7rem"></span>
              </div>
              <div class="col-sm-3 cajas" >
                <a href="../../apps/ArchivosCompartidos/Vista2.php">
                <i class="fas fa-bars fa-10x"></i></a>
                    <p class="cantidades" >Archivos por eje  <span id="eje_arch_compa" ></span> </p>
                    <span id="arch_compa_eje" style=" font-size: .7rem"></span>
              </div>
                  <div class="col-sm-3 cajas" >
                    <a href="../../apps/ArchivosCompartidos/Vista2.php">
                    <i class="far fa-calendar-alt fa-10x"></i></a>
                    <p class="cantidades" >Archivos por año <span id="anio_arch_compa" ></span></p>
                    <span id="arch_compa_anio" style=" font-size: .7rem"></span>
              </div>
          </div>
        </br>
          <div class="row justify-content-center">
              <div class="col-sm-3 cajas">
                ...
                <p class="cantidades" >Archivos por exposición <span id="expo_arch_compa" ></span></p>
                <span id="arch_compa_expo" style=" font-size: .7rem"></span>
              </div>
              <div class="col-sm-3 cajas" >
                <a href="../../apps/ArchivosCompartidos/Vista2.php">
                <i class="fas fa-layer-group fa-10x"></i></a>
                <p class="cantidades" >Archivos por área <span id="origen_arch_compa" ></span></p>
                <span id="arch_compa_origen" style=" font-size: .7rem"></span>
              </div>
              <div class="col-sm-3 cajas" >
    ...
    <script src="./portada_arch_compa.js"></script>
