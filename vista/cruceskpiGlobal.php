...
*/
	...
	$("#imprimeCuadros").html("<div  class=' A j cud lin' style='padding: 24.6px 0;position:absolute;cursor:default'><p class='titP'>KPI´s Globales      <a  href='indicadores.php?tipoPerfil=<?php echo $tipoPerfil; ?>&idUsuario=<?php echo $idUsuario; ?>&nombreUsuario=<?php echo $nombreUsuario; ?>'>	<i style='float:right; cursor:pointer;color: #000;' class='fas fa-undo'></i></a>  <a href='cruceskpi.php?tipoPerfil=<?php echo $tipoPerfil; ?>&idUsuario=<?php echo $idUsuario; ?>&nombreUsuario=<?php echo $nombreUsuario; ?>'><i style=' cursor:pointer;float:right;position: relative;right: 20px;' class='fas fa-calendar-alt'></i> </a></p></div>"+dv);
	
	

	function reset_colors(){
		$(".A.j.cu").css("background-color", "#e7e7e5");
...
function obtener_cruces(){
	$.ajax({
				 type: "POST",
				 url: "../source/controller/CrucesKPIGlobalController.php",
...
function abreDiv(idArea,idEje)
{
	...
	$.post("kpiListaGlobal.php",{idArea:idArea,idEje:idEje}, function( data ) 
	{
