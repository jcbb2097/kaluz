...
<!-- cambio quitar cuadros aqui
<p class="ejpos1"></p>
<div class="eje1"></div>
<div class="eje12"><img hidden class="imgEje1" src="../resources/img/flechaB.png"></div>
<div class="eje123"></div>
<div class="eje1231"><img hidden class="imgEje1a" src="../resources/img/flechaA.png"></div>
<div class="eje1232"><img hidden class="imgEje1a" src="../resources/img/flechaA.png"></div>
<div class="eje1233"><img hidden class="imgEje1a" src="../resources/img/flechaA.png"></div>
<div class="eje1234"><img hidden class="imgEje1a" src="../resources/img/flechaA.png"></div>
<div class="eje1235"><img hidden class="imgEje1a" src="../resources/img/flechaA.png"></div>
<div class="eje1236"><img hidden class="imgEje1a" src="../resources/img/flechaA.png"></div>

<p class="ejpos2"></p>
<div class="eje2"></div>
<div class="eje22"><img hidden class="imgEje2" src="../resources/img/flechaB.png"></div>
<div class="eje223"></div>
<div class="eje2231"><img hidden class="imgEje2a" src="../resources/img/flechaA.png"></div>
<div class="eje2232"><img hidden class="imgEje2a" src="../resources/img/flechaA.png"></div>
<div class="eje2233"><img hidden class="imgEje2a" src="../resources/img/flechaA.png"></div>
<div class="eje2234"><img hidden class="imgEje2a" src="../resources/img/flechaA.png"></div>
<div class="eje2235"><img hidden class="imgEje2a" src="../resources/img/flechaA.png"></div>
<div class="eje2236"><img hidden class="imgEje2a" src="../resources/img/flechaA.png"></div>
<div class="eje2237"><img hidden class="imgEje2a" src="../resources/img/flechaA.png"></div>

<p class="ejpos3"></p>
<div class="eje3"></div>
<div class="eje32"><img hidden class="imgEje3" src="../resources/img/flechaB.png"></div>
<div class="eje323"></div>
<div class="eje3231"><img hidden class="imgEje3a" src="../resources/img/flechaA.png"></div>
<div class="eje3232"><img hidden class="imgEje3a" src="../resources/img/flechaA.png"></div>
<div class="eje3233"><img hidden class="imgEje3a" src="../resources/img/flechaA.png"></div>
<div class="eje3234"><img hidden class="imgEje3a" src="../resources/img/flechaA.png"></div>


<p class="ejpos4"></p>
<div class="eje4"></div>
<div class="eje42"><img hidden class="imgEje4" src="../resources/img/flechaB.png"></div>
<div class="eje423"></div>
<div class="eje4231"><img hidden class="imgEje4a" src="../resources/img/flechaA.png"></div>
<div class="eje4232"><img hidden class="imgEje4a" src="../resources/img/flechaA.png"></div>
<div class="eje4233"><img hidden class="imgEje4a" src="../resources/img/flechaA.png"></div>
<div class="eje4234"><img hidden class="imgEje4a" src="../resources/img/flechaA.png"></div>
<div class="eje4235"><img hidden class="imgEje4a" src="../resources/img/flechaA.png"></div>
<div class="eje4236"><img hidden class="imgEje4a" src="../resources/img/flechaA.png"></div>
<div class="eje4237"><img hidden class="imgEje4a" src="../resources/img/flechaA.png"></div>

<p class="ejpos5"></p>
<div class="eje5"></div>
<div class="eje52"><img hidden class="imgEje5" src="../resources/img/flechaB.png"></div>
<div class="eje523"></div>
<div class="eje5231"><img hidden class="imgEje5a" src="../resources/img/flechaA.png"></div>
<div class="eje5232"><img hidden class="imgEje5a" src="../resources/img/flechaA.png"></div>
<div class="eje5233"><img hidden class="imgEje5a" src="../resources/img/flechaA.png"></div>
<div class="eje5234"><img hidden class="imgEje5a" src="../resources/img/flechaA.png"></div>
<div class="eje5235"><img hidden class="imgEje5a" src="../resources/img/flechaA.png"></div>
<div class="eje5236"><img hidden class="imgEje5a" src="../resources/img/flechaA.png"></div>

<p class="ejpos6"></p>
<div class="eje6"></div>
<div class="eje62"><img hidden class="imgEje6" src="../resources/img/flechaB.png"></div>
<div class="eje623"></div>
<div class="eje6231"><img hidden class="imgEje6a" src="../resources/img/flechaA.png"></div>
<div class="eje6232"><img hidden class="imgEje6a" src="../resources/img/flechaA.png"></div>
<div class="eje6233"><img hidden class="imgEje6a" src="../resources/img/flechaA.png"></div>
<div class="eje6234"><img hidden class="imgEje6a" src="../resources/img/flechaA.png"></div>
<div class="eje6235"><img hidden class="imgEje6a" src="../resources/img/flechaA.png"></div>
<div class="eje6236"><img hidden class="imgEje6a" src="../resources/img/flechaA.png"></div>

<p class="ejpos7"></p>
<div class="eje7"></div>
<div class="eje72"><img hidden class="imgEje7" src="../resources/img/flechaB.png"></div>
<div class="eje723"></div>
<div class="eje7231"><img hidden class="imgEje7a" src="../resources/img/flechaA.png"></div>
<div class="eje7232"><img hidden class="imgEje7a" src="../resources/img/flechaA.png"></div>
<div class="eje7233"><img hidden class="imgEje7a" src="../resources/img/flechaA.png"></div>
<div class="eje7234"><img hidden class="imgEje7a" src="../resources/img/flechaA.png"></div>
<div class="eje7235"><img hidden class="imgEje7a" src="../resources/img/flechaA.png"></div>
<div class="eje7236"><img hidden class="imgEje7a" src="../resources/img/flechaA.png"></div>
<div class="eje7237"><img hidden class="imgEje7a" src="../resources/img/flechaA.png"></div>
<div class="eje7238"><img hidden class="imgEje7a" src="../resources/img/flechaA.png"></div>
<div class="eje7239"><img hidden class="imgEje7a" src="../resources/img/flechaA.png"></div>

<p class="ejpos8"></p>
<div class="eje8"></div>
<div class="eje82"><img hidden class="imgEje8" src="../resources/img/flechaB.png"></div>
<div class="eje823"></div>
<div class="eje8231"><img hidden class="imgEje8a" src="../resources/img/flechaA.png"></div>
<div class="eje8232"><img hidden class="imgEje8a" src="../resources/img/flechaA.png"></div>
<div class="eje8233"><img hidden class="imgEje8a" src="../resources/img/flechaA.png"></div>
<div class="eje8234"><img hidden class="imgEje8a" src="../resources/img/flechaA.png"></div>
<div class="eje8235"><img hidden class="imgEje8a" src="../resources/img/flechaA.png"></div>
<div class="eje8236"><img hidden class="imgEje8a" src="../resources/img/flechaA.png"></div>
<div class="eje8237"><img hidden class="imgEje8a" src="../resources/img/flechaA.png"></div>

<p class="ejpos9"></p>
<div class="eje9"></div>
<div class="eje92"><img hidden class="imgEje9" src="../resources/img/flechaB.png"></div>
<div class="eje923"></div>
<div class="eje9231"><img hidden class="imgEje9a" src="../resources/img/flechaA.png"></div>
<div class="eje9232"><img hidden class="imgEje9a" src="../resources/img/flechaA.png"></div>
<div class="eje9233"><img hidden class="imgEje9a" src="../resources/img/flechaA.png"></div>
<div class="eje9234"><img hidden class="imgEje9a" src="../resources/img/flechaA.png"></div>
<div class="eje9235"><img hidden class="imgEje9a" src="../resources/img/flechaA.png"></div>
<div class="eje9236"><img hidden class="imgEje9a" src="../resources/img/flechaA.png"></div>
<div class="eje9237"><img hidden class="imgEje9a" src="../resources/img/flechaA.png"></div>
<div class="eje9238"><img hidden class="imgEje9a" src="../resources/img/flechaA.png"></div>
<div class="eje9239"><img hidden class="imgEje9a" src="../resources/img/flechaA.png"></div>
<div class="eje92310"><img hidden class="imgEje9a" src="../resources/img/flechaA.png"></div>

<p class="ejpos10"></p>
<div class="eje10"></div>
<div class="eje102"><img hidden class="imgEje10" src="../resources/img/flechaB.png"></div>
<div class="eje1023"></div>
<div class="eje10231"><img hidden class="imgEje10a" src="../resources/img/flechaA.png"></div>
<div class="eje10232"><img hidden class="imgEje10a" src="../resources/img/flechaA.png"></div>
<div class="eje10233"><img hidden class="imgEje10a" src="../resources/img/flechaA.png"></div>
<div class="eje10234"><img hidden class="imgEje10a" src="../resources/img/flechaA.png"></div>
<div class="eje10235"><img hidden class="imgEje10a" src="../resources/img/flechaA.png"></div>
<div class="eje10236"><img hidden class="imgEje10a" src="../resources/img/flechaA.png"></div>
<div class="eje10237"><img hidden class="imgEje10a" src="../resources/img/flechaA.png"></div>
<div class="eje10238"><img hidden class="imgEje10a" src="../resources/img/flechaA.png"></div>

<p class="ejpos11"></p>
<div class="eje11"></div>
<div class="eje112"><img hidden class="imgEje11" src="../resources/img/flechaB.png"></div>
<div class="eje1123"></div>
<div class="eje11231"><img hidden class="imgEje11a" src="../resources/img/flechaA.png"></div>
<div class="eje11232"><img hidden class="imgEje11a" src="../resources/img/flechaA.png"></div>
<div class="eje11233"><img hidden class="imgEje11a" src="../resources/img/flechaA.png"></div>
<div class="eje11234"><img hidden class="imgEje11a" src="../resources/img/flechaA.png"></div>
<div class="eje11235"><img hidden class="imgEje11a" src="../resources/img/flechaA.png"></div>
<div class="eje11236"><img hidden class="imgEje11a" src="../resources/img/flechaA.png"></div>
<div class="eje11237"><img hidden class="imgEje11a" src="../resources/img/flechaA.png"></div>
<div class="eje11238"><img hidden class="imgEje11a" src="../resources/img/flechaA.png"></div>
<div class="eje11239"><img hidden class="imgEje11a" src="../resources/img/flechaA.png"></div>
<div class="eje112310"><img hidden class="imgEje11a" src="../resources/img/flechaA.png"></div>
<div class="eje112311"><img hidden class="imgEje11a" src="../resources/img/flechaA.png"></div>
<div class="eje112312"><img hidden class="imgEje11a" src="../resources/img/flechaA.png"></div> -->
...
<div id="ex1" class="modal" style="background-color: #8d8d8d;font-family: muli-regular;height:285px;">
  ...
  <div  style="width:25%;float:left;">
    <table cellspacing="0" class="compactar" cellpadding="0" style="border: none;width:100%;border-radius: 6px;background-color:#4d4d57;min-height: 216px;">
			<thead style="">
				<tr>
	    		<th onclick="cambio_menu('avances_menu')" style="font-size: 10px;;color:white;padding:5px;font-weight: 100;">Avance</th>
	    	</tr>
			</thead>
			<tbody style="font-size: 10px;">
				<tr class="es_menu avances_menu" style="padding:5px;background-color:white">
					<td  onclick="setTitulo(this,1);" data-titulo="Avance / Entregables" style="padding: 4px;cursor:pointer">Entregables</td>
				</tr>
				<tr class="es_menu avances_menu" style="padding:5px;background-color:white">
					<td onclick="setTitulo(this,2)" data-titulo="Avance / Insumos" style="padding: 4px;cursor:pointer">Insumos</td>
				</tr>
				<tr class="es_menu avances_menu" style="padding:5px;background-color:white">
					<td id="primero" onclick="setTitulo(this,3)" data-titulo="Avance / Entregables e Insumos" style="padding: 4px;cursor:pointer">Entregables e Insumos</td>
				</tr>
				<tr>
	    		<th onclick="cambio_menu('asuntos_menu')" style="font-size: 10px;;color:white;padding:5px;font-weight: 100;">Asuntos</th>
	    	</tr>
				<tr class="es_menu asuntos_menu" style="padding:5px;background-color:white;display:none">
					<td style="padding: 4px;">Enviados</td>
				</tr>
				<tr class="es_menu asuntos_menu" style="padding:5px;background-color:white;display:none">
					<td style="padding: 4px;">&nbsp;&nbsp;&nbsp;-Resueltos</td>
				</tr>
				<tr class="es_menu asuntos_menu" style="padding:5px;background-color:white;display:none">
					<td style="padding: 4px;">&nbsp;&nbsp;&nbsp;-Abiertos</td>
				</tr>
				<tr class="es_menu asuntos_menu" style="padding:5px;background-color:white;display:none">
					<td style="padding: 4px;">Recibidos</td>
				</tr>
				<tr class="es_menu asuntos_menu" style="padding:5px;background-color:white;display:none">
					<td style="padding: 4px;">&nbsp;&nbsp;&nbsp;-Resueltos</td>
				</tr>
				...
				<tr>
	    		<th  style="font-size: 10px;;color:white;padding:5px;font-weight: 100;">Opiniones</th>
					<!-- onclick="cambio_menu('opiniones_menu')" -->
	    	</tr>
				<tr class="es_menu opiniones_menu" style="padding:5px;background-color:white;display:none">
					<td style="padding: 4px;">Atendidas</td>
				</tr>
				<tr class="es_menu opiniones_menu" style="padding:5px;background-color:white;display:none">
					<td style="padding: 4px;">Pendientes</td>
				</tr>
				<tr>
	    		<th onclick="cambio_menu('presupuesto_menu')" style="font-size: 10px;;color:white;padding:5px;font-weight: 100;">Presupuesto</th>
	    	</tr>
				<tr class="es_menu presupuesto_menu" style="padding:5px;background-color:white;display:none">
					<td style="padding: 4px;">Autorizado</td>
				</tr>
				<tr class="es_menu presupuesto_menu" style="padding:5px;background-color:white;display:none">
					<td style="padding: 4px;">Ejercido</td>
				</tr>
				<tr class="es_menu presupuesto_menu" style="padding:5px;background-color:white;display:none">
					<td style="padding: 4px;">Por ejercer</td>
				</tr>
				<tr>
	    		<th onclick="cambio_menu('acuerdos_menu')" style="font-size: 10px;;color:white;padding:5px;font-weight: 100;">Acuerdos</th>
	    	</tr>
				<tr class="es_menu acuerdos_menu" style="padding:5px;background-color:white;display:none">
					<td style="padding: 4px;">Resueltos</td>
				</tr>
				<tr class="es_menu acuerdos_menu" style="padding:5px;background-color:white;display:none">
					<td style="padding: 4px;">Sin resolver</td>
				</tr>
				<tr class="es_menu acuerdos_menu" style="padding:5px;background-color:white;display:none;border-radius: 0px 0px 10px 10px !important;">
					<td style="padding: 4px;">Resueltos y sin resolver</td>
				</tr>
...
<div id="ex2" class="modal" style="background-color: #8d8d8d;font-family: muli-regular;height:400px;">
  ...
  <div class="column2" style="">
    <table cellspacing="0" cellpadding="0" style="border: none;width:100%;border-radius: 6px;background-color:#4d4d57;">
			<thead style="">
				<tr>
	    		<th colspan="3" style="font-size: 10px;;color:white;padding:5px;font-weight: 100;">Insumos</th>
	    	</tr>
			</thead>
			<tbody style="font-size: 10px;">
				<tr style="padding:5px;background-color:white">
					<td style="padding: 4px;">1</td>
					<td style="padding: 4px;">Lista de obra</td>
					<td style="padding: 4px;"><i class="fa fa-file"></i></td>
				</tr>
				<tr style="padding:5px;background-color:white">
					<td style="padding: 4px;">2</td>
					<td style="padding: 4px;">Oficio de validación</td>
					<td style="padding: 4px;"><i class="fa fa-file"></i></td>
				</tr>
				<tr style="padding:5px;background-color:white">
					<td style="padding: 4px;">3</td>
					<td style="padding: 4px;">Imágenes</td>
					<td style="padding: 4px;"><i class="fa fa-camera"></i></td>
				</tr>
				<tr style="background-color:white;border-radius: 0px 0px 10px 10px !important;">
					<td colspan="3" style="border-radius: 0px 0px 10px 10px !important;"><br></td>
				</tr>
			</tbody>

    </table>

		<table cellspacing="0" cellpadding="0" style="border: none;width:100%;border-radius: 6px;background-color:#4d4d57;margin-top:10px">
			<thead style="">
				<tr>
					<th colspan="2" style="font-size: 10px;;color:white;padding:5px;font-weight: 100;">Acuerdos</th>
				</tr>
			</thead>
			<tbody style="font-size: 10px;">
				<tr style="padding:5px;background-color:white">
					<td style="padding: 4px;">1</td>
					<td style="padding: 4px;">26 de Febrero de 2022</td>
				</tr>
				<tr style="padding:5px;background-color:white">
					<td style="padding: 4px;">2</td>
					<td style="padding: 4px;">16 de Marzo de 2022</td>
				</tr>
				<tr style="padding:5px;background-color:white">
					<td style="padding: 4px;">3</td>
					<td style="padding: 4px;">21 de Marzo de 2022</td>
				</tr>
				<tr style="background-color:white;border-radius: 0px 0px 10px 10px !important;">
					<td colspan="2" style="border-radius: 0px 0px 10px 10px !important;"><br></td>
				</tr>
			</tbody>
		...
		<table cellspacing="0" cellpadding="0" style="border: none;width:100%;border-radius: 6px;background-color:#4d4d57;margin-top:10px">
			<thead style="">
				<tr>
					<th colspan="2" style="font-size: 10px;;color:white;padding:5px;font-weight: 100;">Presupuesto</th>
				</tr>
			</thead>
			<tbody style="font-size: 10px;">
				<tr style="padding:5px;background-color:white">
					<td style="padding: 4px;">1</td>
					<td style="padding: 4px;">Autorizado $700,000.00</td>
				</tr>
				<tr style="padding:5px;background-color:white">
					<td style="padding: 4px;">2</td>
					<td style="padding: 4px;">Ejercido $100,000.00</td>
				</tr>
				<tr style="padding:5px;background-color:white">
					<td style="padding: 4px;">3</td>
					<td style="padding: 4px;">$Por ejercer 200,000.00</td>
				</tr>
				<tr style="background-color:white;border-radius: 0px 0px 10px 10px !important;">
					<td colspan="2" style="border-radius: 0px 0px 10px 10px !important;"><br></td>
				</tr>
  ...
  <div class="column2" style="">
		<table cellspacing="0" cellpadding="0" style="border: none;width:100%;border-radius: 6px;background-color:#4d4d57;">
			<thead style="">
				<tr>
	    		<th colspan="2" style="font-size: 10px;;color:white;padding:5px;font-weight: 100;">Opiniones</th>
	    	</tr>
			</thead>
			<tbody style="font-size: 10px;">
				<tr style="padding:5px;background-color:white">
					<td style="padding: 4px;">1</td>
					<td style="padding: 4px;">Lista de opiniones</td>
				</tr>
				<tr style="padding:5px;background-color:white">
					<td style="padding: 4px;color:white">.</td>
					<td style="padding: 4px;color:white">.</td>
				</tr>
				<tr style="padding:5px;background-color:white">
					<td style="padding: 4px;color:white">.</td>
		...
		<table cellspacing="0" cellpadding="0" style="border: none;width:100%;border-radius: 6px;background-color:#4d4d57;margin-top:10px">
			<thead style="">
				<tr>
					<th colspan="2" style="font-size: 10px;;color:white;padding:5px;font-weight: 100;">Actividades</th>
				</tr>
			</thead>
			<tbody style="font-size: 10px;">
				<tr style="padding:5px;background-color:white">
					<td style="padding: 4px;">1</td>
					<td style="padding: 4px;">Entrega de presupuesto</td>
				</tr>
				<tr style="padding:5px;background-color:white">
					<td style="padding: 4px;">2</td>
					<td style="padding: 4px;">Revisión de comprobante</td>
				</tr>
				<tr style="padding:5px;background-color:white;border-radius: 0px 0px 10px 10px !important;">
					<td style="padding: 4px;color:white">.</td>
					<td style="padding: 4px;color:white">.</td>
				</tr>
...
.primer_td{
	...
	.bolas{
		background-color: #0000000f;width: 5px;height: 5px;margin-left: 11px;border-radius:15px;
	}
	.bolas_2{
		background-color: #00000054;width: 8px;height: 8px;margin-left: 10px;border-radius:15px;
	}
	.bolas_3{
		background-color: #4f4f4f;width: 10px;height: 10px;margin-left: 10px;border-radius:15px;cursor:pointer;
	}
	.es_blanco{
...
<script>
	...
	for(var f=1; f <=360; f++)
	{
		...
		if(e_y==0){//si es la linea blanca
			...
			dv +="<div  class=' A j cu ejex_"+e_x+" ejey_"+e_y+"' style='cursor:default'><div id='x_"+e_x+"_y_"+e_y+"' class='bolas bolax_"+e_x+" bolay_"+e_y+"'></div></div>";
		}
		if(f%30==0){
			 e_x = 1 ;
			 e_y = e_y +1 ;
	...
	$("#imprimeCuadros").html("<div  class=' A j cud lin' style='padding: 24.6px 0;position:absolute;background-color:transparent !important;cursor:default'><table style='color:#4d4d57;margin-top: -10px;;width: 100%;font-family: muli-regular;font-size:12px'><tr style='vertical-align: baseline;text-align:center;'><td>Inicio</td><td style='cursor:pointer;' onclick='avances()'>Avances</td><td style='cursor:pointer;' onclick='pantalla("+'"entregables"'+")'>Entregables</td><td id='h_asuntos' style='cursor:pointer'>Asuntos<br><span class='men' style='display:none;'><img title='Enviados' onclick='asuntos_enviados();' style='margin-left:2px;margin-right:2px;margin-top:3px;color:#706c73;width: 14px;' class='imgE' src='../resources/img/imgEnviado.png'><i onclick='asuntos_enviados_global();' data-toggle='tooltip' data-placement='bottom' title='Enviados Global' style='margin-left:2px;margin-right:2px;margin-top:3px;cursor:pointer;color:#706c73' class='fa fa-globe' aria-hidden='true' data-original-title='Enviados Global'></i><i onclick='asuntos_recibidos();' data-toggle='tooltip' data-placement='bottom' title='Recibidos' style='margin-left:2px;margin-right:2px;margin-top:3px;color: #706c73;cursor:pointer;' class='fa fa-envelope-open' aria-hidden='true' data-original-title='Recibidos área'></i><i onclick='asuntos_recibidos_global();'  data-toggle='tooltip' data-placement='bottom' title='Recibidos Global' style='margin-left:2px;margin-right:2px;margin-top:3px;cursor:pointer;color:#706c73' class='fa fa-globe' aria-hidden='true' data-original-title='Recibidos Global'></i></span></td><td onclick='pantalla("+'"acuerdos"'+")'>Acuerdos</td><td  >Opiniones</td><td style='cursor:pointer' onclick='aplicaciones()'>Aplicaciones</td><td onclick='pantalla("+'"presupuesto"'+")'>Presupuesto</td><td onclick='pantalla("+'"kpi"'+")'>KPI</td></tr></table></div>"+dv);
...
function obtener_cruces(){
	$.ajax({
				 type: "POST",
				 url: "../source/controller/CrucesEjesAreasController.php",
					 ...
					 if(data==0){
						 ...
						 for (var i = 0; i < obj.length; i++) {
							 if(obj[i].Id_Area==obj[i].Id_AreaResponsable){
								 $(".bolax_"+obj[i].orr+".bolay_"+obj[i].idEje).addClass('bolas_3');
							 }else{
								 $(".bolax_"+obj[i].orr+".bolay_"+obj[i].idEje).addClass('bolas_2');
							 }

							 $("#x_"+obj[i].orr+"_y_"+obj[i].idEje).data("area_responsable",obj[i].AreaResponsable);
							 $("#x_"+obj[i].orr+"_y_"+obj[i].idEje).data("eje_x",obj[i].orr);
							 $("#x_"+obj[i].orr+"_y_"+obj[i].idEje).data("id_area_aux",obj[i].Id_Area);
							 $("#x_"+obj[i].orr+"_y_"+obj[i].idEje).data("eje_y",obj[i].idEje);
...
$(".bolas").hover(function()
{
	if(typeof($(this).data("eje_x")) != "undefined" && $(this).data("eje_x") !== null){
		...
		//$(padre).find('*[data-orden="'+actual_x+'"]').css("background-color","#0093a3");
...
function aplicaciones(){
		//es duplicado
  location.href='aplicaciones.php?tipoPerfil=1&nombreUsuario=<?php echo $_GET['nombreUsuario']; ?>&idUsuario=<?php echo $_GET['idUsuario']; ?>';
}
