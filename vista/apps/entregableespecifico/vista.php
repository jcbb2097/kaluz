        ...
        <div id="recargar">
            <?php
                ...
                $eje = "SELECT ej.idEje AS id_eje, CONCAT(ej.idEje,'. ', ej.Nombre) AS eje, COUNT(*) AS total
                    ...
                    WHERE pe.Id_Periodo= '".$AnioActual."'
                    GROUP BY eje
                    ORDER BY ej.orden";
                ...
                while ($rs = mysqli_fetch_array($resulteje)) {
                    ...
                    $tot=$tot+$rs['total'];
                    echo '<tr><td>'.$rs['eje'].'</td><td><a href="Lista_especificoE.php?F_IdEje='.$rs['id_eje'].'&'.$MisParam.'">'.$rs['total'].'</a></td></tr>';
                }
            ?>
                </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <th scope="col"><?php echo '<a href="Lista_especificoE.php?'.$MisParam.'">'.$tot.'</a>'; ?></th>
                        </tr>
                    </tfoot>
                </table>
            </div>
