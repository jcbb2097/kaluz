...
$FiltroPais=""; //Se inicializa la variable
if ((isset($_GET['F_IdPais']) && $_GET['F_IdPais'] != "")) //Si el parametro existe se procesa
{   $FiltroPais =" AND i.Id_pais=".$_GET['F_IdPais'];}

$FiltroSector="";
if ((isset($_GET['F_IdSector']) && $_GET['F_IdSector'] != ""))
{   $FiltroSector =" AND i.Id_sector=".$_GET['F_IdSector'];}

$FiltroGiro="";
if ((isset($_GET['F_IdGiro']) && $_GET['F_IdGiro'] != ""))
{   $FiltroGiro =" AND i.Id_giro=".$_GET['F_IdGiro'];}
                ...
                <table id="tInstitucion" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                       <?php
                            ...
                            WHERE 1 ".$FiltroGiro.$FiltroSector.$FiltroPais."
                            ORDER BY Nombre
                            ";
                            $ValUser = "'".$MiNomUsr."'";
