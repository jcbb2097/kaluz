...
<head>
    ...
    <title>::.Entregable Check.::</title>
</head>

<body>
    <div class="well well-sm"><a style="color:#fefefe;" href="../../aplicaciones.php?tipoPerfil=1&nombreUsuario=<?php echo $MiNomUsr; ?>&idUsuario=<?php echo $MiIdUsr; ?>">Aplicaciones</a> / <a style="color:#fefefe;" href="Lista_entregablecheck.php?<?php echo $MisParam?>"><?php echo $Aplicacion; ?></a>
        ...
        <div id="recargar">
            <?php
                ...
                while ($rs = mysqli_fetch_array($resulteje)) {
                    ...
                    $tot=$tot+$rs['Total'];
                    echo '<tr><td>'.$rs['DescEje'].'</td><td><a href="Lista_entregablecheck.php?F_IdEje='.$rs['id_eje'].'&'.$MisParam.'">'.$rs['Total'].'</a></td></tr>';
                }
            ?>
                </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <th scope="col"><?php echo '<a href="Lista_entregablecheck.php?'.$MisParam.'">'.$tot.'</a>'; ?></th>
                        </tr>
                    </tfoot>
                </table>
            </div>
