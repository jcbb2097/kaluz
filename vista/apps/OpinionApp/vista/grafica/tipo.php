...
/*created by leasim*/
	...
	$opinion = $act -> mostrarOpinionesTipo();
	$cadena = "";
        ...
        series: {
            ...
            point: {
                events: {
                    click: function () {
                        //alert('value: ' + this.id);
                        muestraDatosTipo(this.id,this.name);
                    }
                }
            }
        }
...
function muestraDatosTipo(id,name)
{
	var id = id;
    var name = name;
	...
	$.confirm({
		...
		content: 'url:central/tipoDatos.php?id='+id+'&idUsuario='+idUsuario,
		buttons: {
			formSubmit: {
				text: 'Cerrar',
