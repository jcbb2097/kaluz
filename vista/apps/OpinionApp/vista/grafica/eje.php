...
/*created by leasim*/
	...
	$opinion = $act -> mostrarOpinionesEje();
	$cadena = "";
...
function muestraDatosEje(id)
{
	...
	$.confirm({
		...
		boxWidth: '800px',
		useBootstrap: false,
		title: 'Opiniones turnadas a eje ',
		content: 'url:central/ejeDatos.php?id='+id+'&idUsuario='+idUsuario,
		buttons: {
			formSubmit: {
				text: 'Cerrar',
