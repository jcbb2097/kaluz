...
$textoCorreo = "";
if($nombreTipo == 'Felicitación')
{
	$textoCorreo = "Gracias por sus amables palabras. Estamos encantados de saber que disfrutó su visita al Museo Kaluz, especialmente que haya disfrutado de [Especificar / detallar en función de la felicitación]. Su satisfacción es nuestra prioridad, y su opinión nos motiva a seguir brindando experiencias memorables. ";
}else if($nombreTipo == 'Solicitud')
{
	$textoCorreo = "En atención a su solicitud, le comento que  [Especificar / Detallar tema].";
}else if($nombreTipo == 'Queja')
{
	$textoCorreo = "Lamento sinceramente que haya experimentado dificultades durante su visita. Agradecemos sus comentarios, que son esenciales para identificar áreas de mejora. Hemos tomado nota de su retroalimentación y estamos trabajando en solucionar [mencionar el problema].";
}else{
	$textoCorreo = "";
}
...
<form style='overflow-x: hidden;' id ="frmRespuestaSC" action="" class="formName" enctype="multipart/form-data" >
	...
	<div class='row'>
		<div style='' class="col-md-12 col-sm-12 col-xs-12">
			<label for="inputsm">Respuesta a opinión</label>
			<div class="form-group">
				<textarea id='respuesta' name="respuesta" style='background-color: #f6f7f6;' class="form-control input-sm descOp" rows="6">Apreciable <?php echo "<b>".$nombre."</b>,"; ?>


<?php echo $textoCorreo; ?>
</textarea>
...
-->
	...
	<input type="hidden" id="email" name="email" class="name form-control" value='<?php echo $email; ?>' />
