...
/*created by leasim*/
	...
	$opiniones = $act -> mostrarOpinionesEje($id);
...
function actualizaTurnado(idOpinion)
{
	var idOpinion = idOpinion;
	var idUsuario = <?php echo $idUsuario; ?>;
	$.confirm({
		...
		boxWidth: '700px',
		useBootstrap: false,
		title: 'Turnar Opinión -> Actualizar',
				...
				action: function () {
					...
					posting.done(function(data)
					{
						...
						if(data == 1)
						{
							$.alert({
								title: 'Opinión',
								content: 'Opinión turnada al eje actualizada correctamente!',
								type:'green',
							});
							...
							$.alert({
								title: 'Opinión',
								content: 'No se pudo actualizar turnar opinión!, intente nuevamente',
								type:'red',
							});
