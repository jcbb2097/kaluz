...
<div class="container-fluid">
	<div class='row'>
		...
		<p style="font-size: 14px;font-family: 'Muli-Bold';">Cálculo de importes de factura para Persona moral</p>
...
function calcularSub(){
	...
	var totalImporteBruto = 0.0;
	var subtotalValor = $("#subtotal").val();
	totalImporteBruto = subtotalValor / 1.16;
	var importe = 0.0;
	importe = $("#importe").val(totalImporteBruto.toFixed(2));
	
	var importe2 = $("#importe").val();
	
	ivaNumero = (importe2 * iva);
	$("#iva").val(ivaNumero.toFixed(2));
