...
<div class="container-fluid">
	<div class='row'>
		...
		<p style="font-size: 14px;font-family: 'Muli-Bold';">Cálculo de importes de factura para RESICO empresarial</p>
...
function calcularBrutoPFP(){
	...
	total =  ((parseFloat(importe) + parseFloat(ivaNumero))-(parseFloat(isrRetTot)));
...
function calcularNetoPFP(){
	...
	factorInverso =	parseFloat(1) + parseFloat(iva) - (parseFloat(isrRet)) ;
