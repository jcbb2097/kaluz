...
$valorpdf="";
$urladjuntopdf="";
file_put_contents("../../../resources/aplicaciones/PDF/AcuerdosEscritos/".$IDAcuerdoEdit.".pdf", $dompdf->output());

$extension = $IDAcuerdoEdit.".pdf";
//echo $extension;
...
//kaluz para abrir ventana emergente
    if (strpos($_SERVER['HTTP_HOST'], "kaluz") === false) {
        //sie
        $irpdf= "https://siemuseo.com/sie/resources/aplicaciones/PDF/AcuerdosEscritos/".$IDAcuerdoEdit.".pdf";
        $urladjuntopdf= "https://siemuseo.com/sie/resources/aplicaciones/PDF/AcuerdosEscritos/".$valorpdf."";
    }else{
        $irpdf= "https://siekaluz.com/sie/resources/aplicaciones/PDF/AcuerdosEscritos/".$IDAcuerdoEdit.".pdf";
        $urladjuntopdf= "https://siekaluz.com//sie/resources/aplicaciones/PDF/AcuerdosEscritos/".$valorpdf."";
    }
}else{
$irpdf= "https://administro.mx/pruebassie/sie/resources/aplicaciones/PDF/AcuerdosEscritos/".$IDAcuerdoEdit.".pdf";
$urladjuntopdf= "https://administro.mx/pruebassie/sie/resources/aplicaciones/PDF/AcuerdosEscritos/".$valorpdf."";
}
?>
...
$valorpdf1="";
$urladjuntopdf1="";
file_put_contents("../../../resources/aplicaciones/PDF/AcuerdosEscritos/".$id_acuerdo.".pdf", $dompdf->output());

$extension = $id_acuerdo.".pdf";
//echo $extension;
...
//kaluz para abrir ventana emergente
    if (strpos($_SERVER['HTTP_HOST'], "kaluz") === false) {
        //sie
        $irpdfnuevo= "https://siemuseo.com/sie/resources/aplicaciones/PDF/AcuerdosEscritos/".$id_acuerdo.".pdf";
        $urladjuntopdf1= "https://siemuseo.com/sie/resources/aplicaciones/PDF/AcuerdosEscritos/".$valorpdf1."";
    }else{
        $irpdfnuevo= "https://siekaluz.com/sie/resources/aplicaciones/PDF/AcuerdosEscritos/".$id_acuerdo.".pdf";
        $urladjuntopdf1= "https://siekaluz.com//sie/resources/aplicaciones/PDF/AcuerdosEscritos/".$valorpdf1."";
    }
}else{
$irpdfnuevo= "https://administro.mx/pruebassie/sie/resources/aplicaciones/PDF/AcuerdosEscritos/".$id_acuerdo.".pdf";
$urladjuntopdf1= "https://administro.mx/pruebassie/sie/resources/aplicaciones/PDF/AcuerdosEscritos/".$valorpdf1."";
}
