...
include_once("../../../WEB-INF/Classes/LugarNoticia.class.php");
...
if ($editar == true) {
    $obj = new LugarNoticias();
    $obj->setidLugarNoticia($_GET['id']);
    $obj->getLugarNoticia();
    $lugarnoticia = $obj->getNombre();
}
        ...
        <div id="contenido">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <form class="form-horizontal" id="formLugarNoticia" name="formLugarNoticia">
                        <legend>Catálogo de Lugar Noticia</legend>
                        <div class="form-group form-group-sm">
                            <label class="col-md-2 col-sm-2 col-xs-2  control-label" for="inputState">Lugar Noticia</label>
                            <div class="col-md-4 col-sm-4 col-xs-4">
                                <input type="text" class="form-control" id="lugarnoticia" name="lugarnoticia" value="<?php echo $lugarnoticia; ?>">
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <a onclick="cambiarContenido('#contenido','Lista_lugarNoticia.php');" class="btn btn-default btn-xs">Regresar</a>
                            </div>
                        </div>
                    </form>
                </div>
