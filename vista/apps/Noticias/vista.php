        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="form-group form-group-sm">
                ...
                <div class="col-md-2 col-sm-2 col-xs-2">
                    <select id="selecc" class="form-control" name="selecc" onchange="IndicadorTipo();" style="width:130px">
                        ...
                        <option value="12">Impactos</option>
                        <!-- <option value="13">Valor Comercial</option> -->
                        <option value="14">Valor Comercial Real</option>
                        <option value="15">Origen museo</option>
                        <option value="16">Otro origen</option>
                    </select>
                </div>
