      ...
      <div class="container-fluid" style="margin-bottom: 5%">
          <div class="row justify-content-center">
              <div class="col-sm-3 cajas" >
                      <a href="./vista.php"><img class="img-i" src="./img/total opiniones 1-01.png" ></a>
                    <p class="cantidades" >Lugar de Noticias <span id="total_opiniones" ></span></p>
                    <span id="opiniones_totales" style=" font-size: .7rem"></span>
              </div>
              <div class="col-sm-3 cajas" >
                      <a href="./Home.php"><img class="img-i" src="./img/por tipo-01.png" ></a>
                    <p class="cantidades" >Género <span id="tipo_opiniones" ></span> </p>
