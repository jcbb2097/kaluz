...
include_once("../../../WEB-INF/Classes/TipoMedioNoticia.class.php");
...
if ($editar == true) {
    $obj = new TipoMedio();
    $obj->setidTipoMedio($_GET['id']);
    $obj->getTipoMedio();
    $soportemedio = $obj->getidSoporteMedio();
    $tipomedio = $obj->getNombre();
}
    ...
    <div id="container-fluid" id="contenidoProcesos">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <form class="form-horizontal" id="formTipoMedio" name="formTipoMedio">
                    <legend>Tipo de Medio</legend>
                    <div class="form-group form-group-sm">
                        <label class="col-md-2 col-sm-2 col-xs-2  control-label" for="inputState">Soporte de Medio Relacionado</label>
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <select id="soportemedio" class="form-control" name="soportemedio">
                                <?php
                                    $consultaeje = "SELECT * FROM c_soporteNoticia";
                                    $resultado = $catalogo->obtenerLista($consultaeje);
                                    echo '<option value="">Seleccione una opción</option>';
                                    while ($row = mysqli_fetch_array($resultado)) {
                                        $s = '';
                                        if ($row['IdSoporte'] == $soportemedio) {
                                            $s = 'selected="selected"';
                                        }
                    ...
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <input type="text" id="tipomedio" name="tipomedio" class="form-control" value="<?php echo $tipomedio; ?>">
                        </div>
                    </div>
                    <div class="form-group form-group-sm">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            ...
                            <a onclick="cambiarContenido('#contenido','Lista_tipoMedio.php');" class="btn btn-default btn-xs">Regresar</a>
                        </div>
                    </div>
                </form>
            </div>
