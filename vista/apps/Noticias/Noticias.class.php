...
class Noticias{
	...
	public function agregarNoticia(){
		...
		$catalogo = new Catalogo();
		$consulta = "INSERT INTO c_noticia (Titulo, FechaPublicacion ,idMedio, idTipoMedio, Url, idLugarNoticia, idEtapa, idCalificacion, Activo, Resumen, idAutor, idGenero, FechaNoticia, UsuarioCreacion, FechaCreacion, UsuarioModificacion, FechaModificacion, idEje, idArea, idActividad, idExposicion, idEvento, Archivo, RutaArchivo ) VALUES('".$this->titulo."','".$this->fpub."',".$this->medio.",".$this->tmedio.",'".$this->url."', ".$this->lugarn.", ".$this->etapa.", ".$this->calif.", NULL, '".$this->resumen."', ".$this->autor.", ".$this->genero.", '".$this->fnoticia."', '".$this->UsrCreacion."', NOW(), '".$this->UsrModificacion."', NOW(), ".$this->idEje.", ".$this->idArea.", ".$this->idAct.", ".$this->expo.", ".$this->evento.",'" . $this->archivo . "','" . $this->ruta . "');";
