...
include_once("../../../WEB-INF/Classes/SoporteNoticia.class.php");
...
if ($editar == true) {
    $obj = new SoporteNoticia();
    $obj->setidSoporteNoticia($_GET['id']);
    $obj->getSoporteNoticia();
    $soporte = $obj->getNombre();
}
        ...
        <div id="contenido">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <form class="form-horizontal" id="formsoporteNoticias" name="formsoporteNoticias">
                        <legend>Soporte de Noticia</legend>
                        <div class="form-group form-group-sm">
                            <label class="col-md-2 col-sm-2 col-xs-2  control-label" for="inputState">Soporte de Noticia</label>
                            <div class="col-md-4 col-sm-4 col-xs-4">
                                <input type="text" id="soporte" name="soporte" class="form-control" value="<?php echo $soporte; ?>">
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <a onclick="cambiarContenido('#contenido','Lista_soporteNoticia.php');" class="btn btn-default btn-xs">Regresar</a>
                            </div>
                        </div>
                    </form>
                </div>
