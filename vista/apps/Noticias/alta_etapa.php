...
include_once("../../../WEB-INF/Classes/EtapaNoticia.class.php");
        ...
        <div id="contenido">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <form class="form-horizontal" id="formEtapaNoticia" name="formEtapaNoticia">
                        <legend>Catálogo de Etapa</legend>
                        <div class="form-group form-group-sm">
                            <label class="col-md-2 col-sm-2 col-xs-2  control-label" for="inputState">Etapa Noticia</label>
                            <div class="col-md-4 col-sm-4 col-xs-4">
                                <input type="text" class="form-control" id="etapa" name="etapa" value="<?php echo $etapa; ?>">
                            </div>
                        </div>
                        <div class="form-group form-group-sm">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <a onclick="cambiarContenido('#contenido','Lista_etapa.php');" class="btn btn-default btn-xs">Regresar</a>
                            </div>
                        </div>
                    </form>
                </div>
