...
<body>
    <div class="well well-sm"><a style="color:#fefefe;" href="../../aplicaciones.php?tipoPerfil=1&nombreUsuario=<?php echo $MiNomUsr; ?>&idUsuario=<?php echo $MiIdUsr; ?>">Aplicaciones</a> / <a style="color:#fefefe;" href="Lista_intervalo.php?<?php echo $MisParam?>"><?php echo $Aplicacion; ?></a>
        ...
        <div id="recargar">
            <?php
                ...
                while ($rs = mysqli_fetch_array($resulteje)) {
                    ...
                    $tot=$tot+$rs['Total'];
                    //echo '<tr><td>'.$rs['DescEje'].'</td><td><a href="Lista_intervalo.php?F_IdEje='.$rs['id_eje'].'&'.$MisParam.'">'.$rs['Total'].'</a></td></tr>';
            ...
            ?>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <!--<th scope="col"><?php echo '<a href="Lista_intervalo.php?'.$MisParam.'">'.$tot.'</a>'; ?></th>-->
