...
<body>
    ...
    / <a style="color:#fefefe;" href="javascript:window.location.reload(true)">Indicadores</a></div>
     <div class="well2 wr">
            ...
            <a style="color:#fefefe; cursor: pointer;" href="Lista_categorias.php?<?php echo $MisParam?>">Lista de Categorías y subcategorías</a> /
            <a style="color:#fefefe; cursor: pointer;" onclick="Alta(<?php echo $MiIdUsr; ?>,56,'Alta_categorias.php?accion=guardar&tipoPerfil=1&nombreUsuario=<?php echo $MiNomUsr; ?>&idUsuario=<?php echo $MiIdUsr; ?>');">Agregar +</a>
        </div>
        ...
        <div id="recargar">
            <?php
                ...
                while ($rs = mysqli_fetch_array($resulteje)) {
                    ...
                    $tot=$tot+$rs['Total'];
                    echo '<tr><td>'.$rs['DescEje'].'</td><td><a href="Lista_categorias.php?F_IdEje='.$rs['id_eje'].'&'.$MisParam.'&F_IdAnio='.$AnioActual.'">'.$rs['Total'].'</a></td></tr>';
                }
            ?>
                </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <th scope="col"><?php echo '<a href="Lista_categorias.php?'.$MisParam.'&F_IdAnio='.$AnioActual.'">'.$tot.'</a>'; ?></th>
                        </tr>
                    </tfoot>
                </table>
            </div>
