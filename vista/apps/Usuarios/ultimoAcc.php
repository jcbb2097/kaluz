    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xs-8">
                <table class="table table-striped table-bordered table-responsive" style="width:100%" id="ultAcc">
                <thead class="thead-light">
                    ...
                    <tbody>
                            <?php
                            $Consulta = "SELECT MAX(UL.Fecha) AS Fecha,
                            ...
                            WHERE U.Activo=1 GROUP BY UL.idUsuario ORDER BY Fecha DESC";
...
// DataTable
var table = $('#ulAcc').DataTable();
table.destroy();
table = $('#ultAcc').DataTable({
  order:[],
    "language": {
