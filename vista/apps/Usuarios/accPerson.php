    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-sm-8 col-xs-8">
                <table class="table table-striped table-bordered table-responsive" style="width:100%" id="userAcc">
                    <thead>
                        <tr>
                            <th>Acceso</th>
                            <th>Aplicación</th>
                    ...
                    <tbody>
                            <?php
                            $Consulta = "SELECT UL.Fecha AS Fecha, if(ISNULL(A.Descripcion),if(UL.Accion = 1,'Login','Cambio password'),A.Descripcion)  AS Aplicacion,
                            ...
                            left JOIN c_aplicaciones A ON UL.idApp=A.idAplicacion
