...
echo"<li role=\"presentation\" class=\"active\" ><a href=\"#\" onclick=\"cambiarContenidos('#contenidos', 'Menu_por_eje.php');\" >Eje</a></li>";
}
...
?>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <form action="indicadores/VistaIndicador.php" method="get" class="form-horizontal">
                <legend>Indicadores por Eje</legend>
                <div class="row" id="selecteje">
                    <div class="form-group form-group-sm">
                        <label class="col-md-2 col-sm-2 col-xs-2  control-label" for="inputState">Eje</label>
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <select id="Eje" class="form-control" name="Eje" onchange="cargarindicadores();" >
                                <?php
                                $consulta = "SELECT
                                    c_eje.idEje,
                                    c_eje.Nombre 
                    ...
                    <div class="form-group form-group-sm">
                        <label class="col-md-2 col-sm-2 col-xs-2  control-label" for="indicadores1">Indicadores:</label>
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <select id="indicadoresp" name="indicadoresp[]" class="form-control" onchange="Filtroindicador3();">
