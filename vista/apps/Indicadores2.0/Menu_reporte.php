...
<html>
    <head>
        ...
        <script type="text/javascript" language="javascript" src="resources/js/paginas/indicadores/reporte.js" ></script> -->
    </head>
    <body>
        <!-- <h1>Indicadores</h1>   
        ...
        if ($IdMenus[6] == 132 && $IdMenus[7] == 1) {
            echo"<li role=\"presentation\"  class=\"active\"  ><a href=\"#\" onclick=\"cambiarContenidos('#contenidos', 'Menu_reporte.php');\" >Reporte Indicador</a></li>";
        }
        echo"   </ul>";*/
        ?>
<div class="container-fluid">
    <div class="row">
            ...
            <form id="formReporte" name="formReporte" class="form-horizontal">
                ...
                <div class="row">
                    <div class="form-group form-group-sm">
                        <label class="col-md-2 col-sm-2 col-xs-2  control-label" for="inputState">Elija un indicador para hacer un reporte</label>
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <select id="Reporte" class="form-control" name="Reporte"  required=""  >
                                <?php
                                $consulta = "SELECT cc.IdIndicador,cc.Descripcion,cc.IdPresentacion
                                    FROM k_indicadores as cc
                                    WHERE cc.IdPresentacion <=10
                                    GROUP BY
                                    cc.Descripcion";
                    ...
                    <div class="form-group form-group-sm">
                        <label class="col-md-2 col-sm-2 col-xs-2  control-label" for="fecha" >Fecha inicio:</label>
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <input id="fechai" name="fechai" type="date" class="form-control" required="" >
                        </div>
                    </div>
                    <div class="form-group form-group-sm">
                        <label class="col-md-2 col-sm-2 col-xs-2  control-label" for="fecha" >Fecha fin:</label>
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            <input id="fechaf" name="fechaf" type="date" class="form-control" required="" >
                        </div>
                    </div>
                    <div class="btn-group" role="group" aria-label="...">
                        <!-- <div class="row"> -->
                            <input type="button" class="btn btn-default btn-xs" id="reporte" type="submit" name="reporte" value="Generar Reporte" />
                        <!-- </div> -->
                    </div><br>

                    <!-- <div class="btn-group" role="group" aria-label="...">
                        <div style="float:right;">
                            <button id="guardar" name="guardar" type="button" class="btn btn-primary btn-lg">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="col-md-12 col-sm-12 col-xs-12" class="row" id="reporte2" >
