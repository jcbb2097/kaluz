...
if (isset($_GET['IndicadorEje']) && $_GET['IndicadorEje'] != "undefined") {
    array_push($idindicador, $_GET['IndicadorEje']);
...
if ($indicador != "") {
    ...
    <tr class="titulo_tabla" align="center"> 
        <td colspan="2" ><font size="3">' . $obj->getDescripcion() . '</font></td>
            ...
            case 3:
                ...
                echo "<script>Highcharts.chart('containerpieee', {
    chart: {
        type: 'pie',
        options3d: {
            enabled: true,
    ...
    series: [{
        ...
        data: [
            " . $se . "
                 ...
                 echo' <div class="col-md-6 col-sm-6 col-xs-6" id="containerpieee" style="min-width: 410px; max-width: 600px; height: 400px; margin: 0 auto"></div>';
                break;
            case 4:
                //barras
                $consulta = $obj->getQueryConsulta();
                ...
                echo "<script>Highcharts.chart('containerbarras', {
    chart: {
        type: 'column',
        options3d: {
            enabled: true,
    ...
    series: [{
        ...
        data: [" . $se . "]
                ...
                echo' <div class="col-md-6 col-sm-6 col-xs-6" id="containerbarras" style="min-width: 410px; max-width: 600px; height: 400px; margin: 0 auto"></div>';
                break;
            case 5:
                //lineal
                $consulta = $obj->getQueryConsulta();
...
";
    ...
    responsive: {
        rules: [{
            ...
            case 6:
                ...
                echo'<div class="row">';
                echo'<div class="col-md-6 col-sm-6 col-xs-6" id="dTindicadoresp" style="display:block;">';
                ...
                echo "<script>Highcharts.chart('containerp', {
    chart: {
        type: 'pie',
        options3d: {
            enabled: true,
        ...
        data: [
            " . $se . "
                ...
                echo'   </tbody>
                   ...
                   echo' <div class="col-md-6 col-sm-6 col-xs-6" id="containerp" style="min-width: 410px; max-width: 600px; height: 400px; margin: 0 auto"></div>';
                break;
            case 7:
                //tabla barras
                $consulta = $obj->getQueryConsulta();
                ...
                echo'<div class="row">';
                echo'<div class="col-md-6 col-sm-6 col-xs-6" id="dTindicadoresb" style="display:block;">';
                ...
                echo' <div class="col-md-6 col-sm-6 col-xs-6" id="containert" style="min-width: 410px; max-width: 600px; height: 400px; margin: 0 auto"></div>';
                echo "<script>Highcharts.chart('containert', {
    chart: {
        type: 'column',
        options3d: {
            enabled: true,
    ...
    series: [{
        ...
        Highcharts.chart('containerpira', {
chart: {
    type: 'pyramid'
},
title: {
...
series: [{
    ...
    data: [
            " . $se . "
                  ...
                  echo' <div id="containerpira" style="min-width: 410px; max-width: 600px; height: 400px; margin: 0 auto"></div>';
                break;
            case 9:
                //piramide tablas
                $consulta = $obj->getQueryConsulta();
                ...
                echo'<div class="row">';
                echo'<div class="col-md-6 col-sm-6 col-xs-6" id="dTindicadorespt" style="display:block;">';
   ...
   echo' <div class="col-md-6 col-sm-6 col-xs-6" id="containertp" style="min-width: 410px; max-width: 600px; height: 400px; margin: 0 auto"></div>';
                echo "<script>
                $(document).ready(function(){
        Highcharts.chart('containertp', {
chart: {
    type: 'pyramid'
},
title: {
