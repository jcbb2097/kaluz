...
if ((isset($_GET['tipo'])      && $_GET['tipo'] != ""))          {
  ...
  switch ($tipo) {
    case '1':
      $where = " and d.Asunto = $idasunto ";
      break;
      case '2':
        $where = " and chek.IdCheckList =  $check ";
        break;
        case '3':
          $where = " and chek.IdCheckList =  $check and d.id_tipo in(9,10,14) ";
          break;
          case '4':
            $where = " and chek.IdCheckList =  $check and d.id_tipo not in(1,2,9,10,11,14) ";
            break;
            case '5':
              $where = " and chek.IdCheckList =  $check and d.id_tipo in(11)";
              break;
    default:
      break;
  }
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <table id="t_entregableasunto_refresh" class="table table-striped table-bordered dataTable display" cellspacing="0" width="100%">
  ...
  $(document).ready(function() {
      ...
      var table = $('#t_entregableasunto_refresh').DataTable({
          "language": {
