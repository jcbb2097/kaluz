...
<body>
  <div class="well well-sm" style="margin-bottom:0px;"><a style="color:#fefefe;" href="../../aplicaciones.php?<?php echo $MisParam; ?>">Aplicaciones</a> /
     ...
     <a href="../../login.php" style="position:absolute; right: 150px; color:white;" > Ir al SIE </a>
...
<div class="container-fluid">
  <div class="row">
    <div class="row">
      ...
      <div class="col-md-5 col-sm-5 col-xs-5 text-center" style="font-size: 21px;">Asuntos <?php echo $nombre; ?> <button type="button" class="btn btn-sm rounded-0 mr-1 btnNew " onclick="nuevoAsunto();"><div class="tooltip2"><i style="font-size:18px;" class="far fa-edit"></i><span class="tooltiptext2">redactar asunto</span></div></button></div>
  ...
  <div style="top: 64px;" class="modal fade" id="modal_nuevoasunto" role="dialog">
    <div class="modal-dialog" style="width: 85%;margin: 30px;">
      <!-- Modal content  style="left: -62px;width: 916px;" -->
      <div class="modal-content">
        <div class="modal-header h" style="padding: 7px 5px;">
          ...
          <center>
            <span style="color:white;" >Redactar nuevo asunto</span>
          </center>
           <a style="color:white;text-decoration:none;" class="resul"></a>
        </div>

        <div class="modal-body detalle" style="padding: 5px 5px;">
              <iframe style='display:none' id='frame_nuevoasunto' width="100%" height="70%" frameborder='0'></iframe>
        </div>
...
<input type="hidden" name="areaor" id="areaor" value="<?php echo $idejearea; ?>">
<input type="hidden" name="ejeareaor" id="ejeareaor" value="<?php echo $ejearea; ?>">
 ...
 let titulo = "";
  switch (rec_env_inv) {
   case 1:
     ...
     if(categoria == 1)
      titulo = "Asuntos abiertos enviados por "+nombrearea+" que nunca ha contestado ";
     if(categoria == 2)
   ...
   case 2:
      ...
      if(categoria == 1)
       titulo = "Asuntos abiertos recibidos por "+nombrearea+" que nunca ha contestado ";
      if(categoria == 2)
   ...
   case 3:
      ...
      if(categoria == 1)
       titulo = "Asuntos abiertos donde "+nombrearea+" es invitado que nunca ha contestado ";
      if(categoria == 2)
...
function nuevoAsunto(){
  ...
  var ejeareaor = $( "#ejeareaor" ).val();

 // $(".h").css('background-color',"#4d4d57");
 // $("#modal_nuevoasunto").modal({backdrop: false});
 // var frame = $('#frame_nuevoasunto'); //   ../ArchivosEntregables/Alta_entregable_2.php
    var url = "../Planeacion/Alta_asunto.php?accion=guardar&tipoPerfil=1&origen=2&areaor="+areaor+"&ejeareaor="+ejeareaor+"&idUsuario="+usr;
    window.location.href = url;
//
// frame.attr('src',url).show();
 // $.post("../Planeacion/Alta_asunto.php?accion=guardar&tipoPerfil=1&idUsuario="+usr,{}, function(data) {
 //   $(".detalle").html('');
 //   $(".detalle").html(data);
 // });
}
...
function adjuntarArchivo(){
 ...
 //
 frame.attr('src',url).show();
 // $.post("tipo_archivo.php",{url:url}, function(data) {
 //   $(".detallearchivo").html('');
