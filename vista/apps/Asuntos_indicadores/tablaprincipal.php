    ...
    <div class="row">
        <div >
                ...
                <thead class="thead-dark">
                    <tr>
                        <th style="text-align: center;border-right: solid"><?php if(isset($_GET['idarea']))echo 'Área';else echo 'Eje'?></th>
                ...
                while ($rs = mysqli_fetch_array($resulteje)) {
                  ...
                  $consulta_avance = "  SELECT  if(AVG(chani.Avance) IS NULL,0,ROUND(AVG(chani.Avance),1)) total
                    ...
                    echo  "<tr id='".$id."'>";
                    if(isset($_GET['idarea']))
                      echo "<td onclick='muestradetalle(".$id.",2,1)' style='cursor:pointer;border-right: solid;'><b>".$rs['nombre']."&nbsp;&nbsp;&nbsp;&nbsp; <a href='estadisticas.php?ejearea=1&idejearea=$id'><i class='fa fa-bar-chart fa-3' aria-hidden='true'></i></a></b> &nbsp; (avance $avance%)</td>";
                    else
                      echo "<td onclick='muestradetalle(".$id.",1,1)' style='cursor:pointer;border-right: solid;' ><b>".$rs['nombre']."</b> &nbsp; (avance $avance%)</td>";
                      $total_fila = 0;
                      $pendientes_fila = 0;
                      foreach ($tipos as $key) {
                        ...
                        while ($rs1 = mysqli_fetch_array($resdatos)){
                          ...
                          if($rs1['sinleer'] > 0)
                            ...
                            echo "<td style='text-align: center;'><a href='#' onclick='muestraDetalle_modal(".$ejearea.",".$idejearea.",$tipo,0,0,".$key.",3,0)'>".$rs1['resuelto']."</a></td>";
                            echo "<td style='text-align: center;$color_amarillo'><a href='#' onclick='muestraDetalle_modal(".$ejearea.",".$idejearea.",$tipo,0,0,".$key.",2,0)'>".$rs1['enconv']."</a></td>";
                            echo "<td style='text-align: center;border-right: solid;$color_rojo'><a href='#' onclick='muestraDetalle_modal(".$ejearea.",".$idejearea.",$tipo,0,0,".$key.",1,0)'>".$rs1['sinleer']."</a></td>";
                  ...
                  echo "<td style='text-align: center;'> <a style='cursor: pointer;' onclick='muestraDetalle_modal(".$ejearea.",".$id.",$tipo,0,0,0,8,0)'>$total_fila </a> ($porcentaje%) / <a style='cursor: pointer;' onclick='muestraDetalle_modal(".$ejearea.",".$id.",$tipo,0,0,0,7,0)'> $pendientes_fila </a> </td>";
                  echo  "</tr>";
