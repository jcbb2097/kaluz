...
<body>
    <div class="well well-sm"><a style="color:#fefefe;" href="../../indicadores.php?tipoPerfil=1">Indicadores</a> / <a style="color:#fefefe;" href="index.php?nombreUsuario=<?php echo ($user); ?>">Indicador Jurídico</a></div>
</body>
<div class="container-fluid">
    <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-6">
            <div class="form-group form-group-sm">
                <label class="col-md-6 col-sm-6 col-xs-6  control-label" for="descripcion">Selecciona un Año:</label>
                <div class="col-md-6 col-sm-6 col-xs-6">
        ...
        <div class="col-md-6 col-sm-6 col-xs-6">
            <div class="form-group form-group-sm">
                <label class="col-md-6 col-sm-6 col-xs-6  control-label" for="indicadorT">Tipo de Indicador:</label>
                <div class="col-md-6 col-sm-6 col-xs-6">
                    <select id="indicadorT" class="form-control" name="indicadorT" onchange="indicador();">
                        <option value="">Seleccione una opción</option>
                        <option value="1">Área</option>
                        <option value="2">Eje</option>
                        <option value="3">Exposición temporal</option>
                        <option value="4">Instrumento Jurídico</option>
        ...
        <div id="recargar">
                ...
                <table id="tArchivo" class="table table-striped table-bordered" style="width:100%">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col" class="col-md-2 col-sm-2 col-xs-2">Tipo</th>
                    ...
                    <tbody>
                        ...
                        echo ' <td>';
                        echo '<ul class="list-group">';
                        echo '	<li class="list-group-item" style="font-size: 10px;">Nacional<span style="font-size: 10px;" class="badge">' . $nacional . '</span></li>';
                        echo '	<li class="list-group-item" style="font-size: 10px;">Internacional &nbsp;<span style="font-size: 10px;" class="badge">' . $Internacional . '</span></li>';
                        echo '	<li class="list-group-item" style="font-size: 10px;">Total<span style="font-size: 10px;" class="badge">' . $total_contratos . '</span></li>';                      
                        echo ' </td>';
                        echo ' <td>';
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
                <table id="tArchivo" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <?php
                        echo ' <td>';
                        $consulta = "SELECT e.Nombre, COUNT( a.Id_juridico ) AS contratos FROM	c_juridico a,c_area e WHERE a.IdArea = e.Id_Area GROUP BY e.Nombre";
                        $resultConsulta = $catalogo->obtenerLista($consulta);
                        while ($row = mysqli_fetch_array($resultConsulta)) {
...
<script>
    function indicador() {
        ...
        var indicador = $('#indicadorT').val()
        //alert (periodo);
        //alert(indicador);
        $("#recargar").load("grafica.php?accion=2&periodo=" + periodo + "&tipo=" + $("#selecc").val() + "&indicador=" + indicador);
    }
</script>
