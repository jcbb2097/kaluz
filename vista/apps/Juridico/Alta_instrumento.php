...
if ($editar == true) {
    ...
    $Instrumento=$juridico->getNombre();
}
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
    <div class="well well-sm"><a style="color:#fefefe;" href="../../aplicaciones.php?tipoPerfil=1">Aplicaciones</a> / <a style="color:#fefefe;" href="Lista_juridico.php?nombreUsuario=<?php echo ($user); ?>">Jurídico</a> / Agregar Instrumento Jurídico </div>
    <div id="container-fluid">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <form class="form-horizontal" id="formInstrumentoJuridico" name="formInstrumentoJuridico">
                    <div class="form-group form-group-sm">
                        <label class="col-md-2 col-sm-2 col-xs-2  control-label" for="AÑO">* Tipo instrumento jurídico:</label>
                        <div class="col-md-2 col-sm-2 col-xs-2">
                        <input type="text" id="Instrumento" name="Instrumento" class="form-control" value="<?php echo ($Instrumento); ?>" />
                        </div>
                    </div>
                    <div class="form-group form-group-sm">
                        <div class="col-md-2 col-sm-2 col-xs-2">
