                ...
                <table id="" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                        ...
                        if ($tipo == 1) { //----------------------------------------Ver por EJE--------------------------------------------
                            ...
                            while ($roweje = mysqli_fetch_array($resulteje)) {
                                ...
                                echo '<td><a href="Lista_entregable.php?F_IdEje='.$roweje['id_eje'].'&F_IdAnio='.$AnioActual.'&'.$MisParam.'">'. $roweje['Total'] .'</a></td>';
                                echo '</tr>';
                                $tot += $roweje['Total'];
                            }
                            ...
                            while ($rowareas = mysqli_fetch_array($resultareas)) {
                                ...
                                echo '<td><a href="Lista_entregable.php?F_IdArea='.$rowareas['idarea'].'&F_IdAnio='.$AnioActual.'&'.$MisParam.'">'. $rowareas['Total'] .'</a></td>';
                                echo '</tr>';
                                $tot += $rowareas['Total'];
                            }
                            ...
                            while ($rowperiodo = mysqli_fetch_array($resultanio)) {
                                ...
                                echo '<td><a href="Lista_entregable.php?F_IdAnio='.$rowperiodo['Anio'].'&'.$MisParam.'">'. $rowperiodo['total'] .'</a></td>';
                                echo '</tr>';
                            ...
                            while ($rowtipo = mysqli_fetch_array($resulttipo)) {
                                ...
                                echo '<td><a href="Lista_entregable.php?F_IdTipo='.$rowtipo['idtipo'].'&F_IdAnio='.$AnioActual.'&'.$MisParam.'">'. $rowtipo['total'] .'</a></td>';
                                echo '</tr>';
                                $tot += $rowtipo['total'];
                            }
                        }
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th scope="col"><?php echo '<a href="Lista_entregable.php?F_IdAnio='.$AnioActual.'&'.$MisParam.'">' . $tot . '</a>'; ?></th>
                        </tr>
                    </tfoot>
                </table>
            </div>
