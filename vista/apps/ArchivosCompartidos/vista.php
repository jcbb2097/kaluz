...
$Aplicacion="Archivos Compartidos";
...
<body>
    <div class="well well-sm"><a style="color:#fefefe;" href="../../aplicaciones.php?tipoPerfil=1&nombreUsuario=<?php echo $MiNomUsr; ?>&idUsuario=<?php echo $MiIdUsr; ?>">Aplicaciones</a> / <a style="color:#fefefe;" href="lista_archivo.php?tipoPerfil=1&nombreUsuario=<?php echo $MiNomUsr; ?>&idUsuario=<?php echo $MiIdUsr; ?>"><?php echo $Aplicacion; ?></a>
    / <a style="color:#fefefe;" href="javascript:window.location.reload(true)">Indicadores</a></div>
     <div class="well2 wr">
            ...
            <a style="color:#fefefe; cursor: pointer;" href="lista_archivo.php?tipoPerfil=1&nombreUsuario=<?php echo $MiNomUsr; ?>&idUsuario=<?php echo $MiIdUsr; ?>">Lista Archivos Compartidos</a> /
            <a style="color:#fefefe; cursor: pointer;" onclick="Alta(<?php echo $MiIdUsr ?>,13,'Alta_archivo.php?accion=guardar&tipoPerfil=1&nombreUsuario=<?php echo $MiNomUsr; ?>&idUsuario=<?php echo $MiIdUsr; ?>&regreso=1');">Agregar +</a>
        </div>
        ...
        <div id="recargar">
            <?php
                ...
                while ($rs = mysqli_fetch_array($resulteje)) {
                    ...
                    $tot=$tot+$rs['Total'];
                    echo '<tr><td>'.$rs['DescEje'].'</td><td><a href="lista_archivo.php?F_IdEje='.$rs['id_eje'].'&'.$MisParam.'&F_IdAnio='.$AnioActual.'">'.$rs['Total'].'</a></td></tr>';
                }
            ?>
                </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <th scope="col"><?php echo '<a href="lista_archivo.php?'.$MisParam.'&F_IdAnio='.$AnioActual.'">'.$tot.'</a>'; ?></th>
                        </tr>
                    </tfoot>
                </table>
            </div>
