...
if (isset($_POST['accion']) && $_POST['accion'] != "") {
    ...
    switch ($_POST['accion']) {
        case 'guardar':
          ...
          $obj->setvisible($parametros['tieneanios']);
          if (isset($parametros['entregable'])) {
                $obj->setnombreentregable($parametros['entregable']);
            }else {
                $obj->setnombreentregable("");
          }
          ...
          //$IdEntregable= $objE->agregarEntregable();
            if ($obj->agregarActividadMeta()) {
                 ...
                 $aniosvisibles1=$parametros['aniovisible'];
                  for ($is=0; $is < count($aniosvisibles1); $is++) { 
                  $obj->setaniovisible($aniosvisibles1[$is]);
                  $obj->kvisibleActividad();
                  }
