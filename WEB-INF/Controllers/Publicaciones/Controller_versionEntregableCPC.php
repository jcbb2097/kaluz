...
if (isset($_POST['accion']) && $_POST['accion'] != "") {
    ...
    switch ($_POST['accion']) {
        case 'guardar':
            ...
            $objAC->setDescripcion('Archivo Carpeta Presentacion Catalogo Preliminar del libro ' . $parametros['tituloVer'] . '. Versión_' . $fechaHora);
            ...
            if (isset($_FILES[5])) {
                $agregoArchivo = true;
                //echo '1';
                if (file_exists("../../../" . $rutaPDF . $_FILES[5]['name'])) {
                    //echo '<br>2<br>';
                    $archivo = $_FILES[5]['name'];
                    $resultado = str_replace(" ", "_", $archivo);
                    $explode = explode('.',  $resultado);
                    $extension = array_pop($explode);

                    $nombre = $_FILES[5]['name'];
                ...
                move_uploaded_file($_FILES[5]['tmp_name'], "../../../" . $nameimg);
            } else {
                $agregoArchivo = false;
       ...
       case 'eliminar':
        ...
        $ruta = "../../../resources/aplicaciones/Entregables/Publicaciones/ElaborarCarpetaPresentacion/ElaborarSinopsisCatalogo/Preliminar/";
        $objAC->getAcuerdo();
